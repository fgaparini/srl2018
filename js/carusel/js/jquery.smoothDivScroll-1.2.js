		...
		**********************************************************/
		...
		_showHideHotSpots: function () {
			...
			// Autoscrolling not set to always and hotspot scrolling enabled
				...
				// should be hidden
				if (typeof el.data("scrollWrapper") === "undefined") {
					return false;
				}
				...
				// and the right hotspot visible.
					...
					el.data("scrollingHotSpotLeft").addClass('unact').show();
				...
				// and the left hotspot visible
					...
					el.data("scrollingHotSpotLeft").removeClass('unact').show();
					
					el.data("scrollingHotSpotRight").addClass('unact').show();
					// Callback
				...
				// scrolling, both hotspots should be visible
					...
					el.data("scrollingHotSpotLeft").removeClass('unact').show();
					el.data("scrollingHotSpotRight").removeClass('unact').show();
