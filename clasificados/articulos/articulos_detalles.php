...
if (isset($_GET['articulos_id'])) {
  $colname_Recordset3 = $_GET['articulos_id'];
}
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset3 = sprintf("SELECT * FROM preguntas WHERE clasificado_id = %s AND preguntas.tipo_clasi = 'articulos'", GetSQLValueString($colname_Recordset3, "text"));
...
if (isset($_GET['articulos_id'])) {
  $colname_Recordset1 = $_GET['articulos_id'];
}
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset1 = sprintf("SELECT * FROM articulos WHERE articulos_id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<title><?php echo $row_Recordset1['nombre']; ?> || Articulos en San Rafael || Venta y Compra || Clasificados SRL || San Rafael || </title>
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr></tr>
        <tr>
          <td class="rubros"><a href="articulos.php">Articulos &gt;&gt;</a> <a href="articulos.php?rubro=<?php echo $row_Recordset1['rubro']; ?>"><?php echo $row_Recordset1['rubro']; ?>&gt;&gt;</a></td>
        </tr>
        <tr>
        ...
        <tr>
          <td bgcolor="#FFFFFF"><div align="right">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea_detalles">
              <tr>
                <td width="3%">&nbsp;</td>
                <td width="51%" valign="middle"><div align="right"><span class="texto_link_chico"><a href="#" onclick="abrirpopup('../sistema/guardar_anuncio.php?anuncio_id=<?php echo $row_Recordset1['articulos_id']; ?>&&base_datos=articulos',350,350)"><img src="../iconos/agrega_favoritos.jpg" alt="Agregar a favoritos" width="25" height="25" border="0" align="absmiddle" title="Agregue Anuncio a Anuncios Guardados" /> </a><a href="#" onclick="abrirpopup('../sistema/guardar_anuncio.php?anuncio_id=<?php echo $row_Recordset1['articulos_id']; ?>&amp;&amp;base_datos=articulos',450,450)">guardar  para seguimiento</a></span></div></td>
                <td width="5%" valign="middle">&nbsp;</td>
                <td width="14%" valign="middle"><div align="left"><span class="texto_link_chico"><a href="#" onclick="abrirpopup('../sistema/guardar_anuncio.php?anuncio_id=<?php echo $row_Recordset1['articulos_id']; ?>&amp;&amp;base_datos=articulos',450,450)"> </a></span><span class="texto_link_chico"><a  href="#" onclick="abrirpopup('../sistema/imprimir_ficha.php?anuncio_id=<?php echo $row_Recordset1['articulos_id']; ?>&amp;&amp;base_datos=articulos',450,500)"><img src="../iconos/imprimir.png" alt="Imprimir anuncio" width="25" height="25" border="0" align="absmiddle"  title="Imprima Anuncio" /> </a><a  href="#" onclick="abrirpopup('../sistema/imprimir_ficha.php?anuncio_id=<?php echo $row_Recordset1['articulos_id']; ?>&amp;&amp;base_datos=articulos',450,500)">imprimir</a></span></div></td>
                <td width="3%" valign="middle">&nbsp;</td>
                <td width="24%" valign="middle"><div align="left"><span class="texto_link_chico"><a  href="#" onclick="abrirpopup('../sistema/enviarxemail.php?anuncio_id=<?php echo $row_Recordset1['articulos_id']; ?>&amp;&amp;base_datos=articulos',450,600)"><img src="../iconos/email-enviar.png" alt="Enviar por Mail" width="30" height="30" border="0" align="absmiddle" />enviar a un amigo</a></span></div></td>
              </tr>
            </table>
          </div></td>
        </tr>
          ...
          <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="46%" height="15" rowspan="2" valign="top" class="division_detalles_fotos"><?php if ($row_Recordset1['imagen'] != NULL) {?>
                <a href="../fotos-clasificados/articulos/<?php echo $row_Recordset1['articulos_id']; ?>.jpg" rel="lightbox[fotos]"><img src="../fotos-clasificados/articulos/<?php echo $row_Recordset1['articulos_id']; ?>.jpg" width="250" height="230" hspace="2" vspace="2" /></a>
                <?php } else {?>
              ...
              <td width="54%" valign="top" class="contenedor_opciones"><table width="97%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="100" height="40" bgcolor="#F9F9F9" class="texto_negro"><strong>Precio:</strong></td>
                  <td width="180" bgcolor="#F9F9F9" class="textoguias">$<?php echo $row_Recordset1['precio']; ?></td>
                </tr>
                
                <tr>
                  <td width="100" class="texto_negro"><strong>Publicado el: </strong></td>
                  <td class="texto_opciones"><?php echo $row_Recordset1['fecha']; ?></td>
                </tr>
                <tr>
                  <td width="100" class="linea_detalles">&nbsp;</td>
                ...
                <tr>
                  <td width="100" bgcolor="#F9F9F9" class="texto_negro"><span class="style2">Empresa:</span></td>
                  <td bgcolor="#F9F9F9" class="texto_opciones"><?php if ($row_Recordset4['empresa'] > 0) { // Show if recordset not empty ?>
                    <strong><?php echo $row_Recordset2['empresa']; ?></strong>
                    <?php } else { echo "Particular" ;} ?></td>
                </tr>
                <tr>
                  <td width="100" bgcolor="#F9F9F9" class="texto_negro"><span class="style2">Direccion:</span></td>
                  <td bgcolor="#F9F9F9" class="texto_opciones"><strong><?php echo $row_Recordset2['direccion']; ?></strong></td>
                </tr>
                <tr>
                  <td width="100" bgcolor="#F9F9F9" class="linea_detalles">&nbsp;</td>
        ...
        <tr>
          <td height="60" bgcolor="#FFFFFF"><a href="articulos.php" class="texto_anuncio">El vendedor de este aviso asume la total responsabilidad de la presente  publicaci&oacute;n. Si consider&aacute;s que este aviso contradice las pol&iacute;ticas de  nuestro sitio. Hac&eacute;  click ac&aacute;.</a></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div align="center">
              <p class="texto_anuncio"><a href="#" class="texto_link_chico" onclick="abrirpopup('../sistema/hacer_pregunta.php?clasi_id=<?php echo $row_Recordset1['articulos_id']; ?>&&tipo_clasi=articulos&&usuario_art_id=<?php echo $row_Recordset1['id_usuario']; ?>',600,450)"><strong>Hacer Pregunta</strong> (solo usuarios registrados) &gt;&gt;</a></p>
          </div></td>
        </tr>
        <tr>
      ...
      <p align="center"><span class="texto_anuncio"><a href="#" class="texto_link_chico" onclick="abrirpopup('../sistema/hacer_pregunta.php?clasi_id=<?php echo $row_Recordset1['articulo_id']; ?>&amp;&amp;tipo_clasi=articulos&amp;&amp;usuario_art_id=<?php echo $row_Recordset1['usuario_id']; ?>',600,450)"><strong>Hacer Pregunta</strong> (solo usuarios registrados) &gt;&gt;</a></span></p>
      <p>&nbsp;</p>
      ...
      <div >
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td class="rubros"><a href="articulos.php">Articulos</a></td>
