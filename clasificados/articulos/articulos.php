...
mysql_select_db($database_clasificados, $clasificados);
if (isset($_GET['rubro'])) { 
$query_Recordset1 = "SELECT * FROM articulos WHERE rubro LIKE '%$rubro2%'  " ; }
else {
$query_Recordset1 = "SELECT * FROM articulos ORDER BY fecha ASC"; } 
...
<title>Articulos en San Rafael || Venta y Compra || Clasificados SRL || San Rafael || </title>
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="titulos_seccion">Articulos</td>
        </tr>
        <tr>
        ...
        <tr>
          <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td bgcolor="#DBE6F0" class="rubros_articulos"><a href="articulos.php?rubro=electrodomesticos">Electrodomesticos &gt;&gt; </a></td>
              <td bgcolor="#DBE6F0" class="rubros_articulos"><a href="articulos.php?rubro=celulares">Celulares &gt;&gt;</a></td>
              <td bgcolor="#DBE6F0" class="rubros_articulos"><a href="articulos.php?rubro=celulares">Tv-Audio-Video &gt;&gt;</a></td>
            </tr>
            <tr>
              <td bgcolor="#DBE6F0" class="rubros_articulos"><a href="articulos.php?rubro=muebles-hogar">Muebles-Hogar &gt;&gt;</a></td>
              <td bgcolor="#DBE6F0" class="rubros_articulos"><a href="articulos.php?rubro=computacion">Computacion &gt;&gt;</a></td>
              <td bgcolor="#DBE6F0" class="rubros_articulos"><a href="articulos.php?rubro=animales">Animales &gt;&gt;</a></td>
            </tr>
            <tr>
              <td bgcolor="#DBE6F0" class="rubros_articulos"><a href="articulos.php?rubro=ropa">Ropa &gt;&gt;</a></td>
              <td bgcolor="#DBE6F0" class="rubros_articulos"><a href="articulos.php?rubro=deportes">Deportes &gt;&gt;</a></td>
              <td bgcolor="#DBE6F0" class="rubros_articulos"><a href="articulos.php?rubro=antiguedades">Antiguedades &gt;&gt;</a></td>
            </tr>
            <tr>
              <td bgcolor="#DBE6F0" class="rubros_articulos"><a href="articulos.php?rubro=juguetes">Jueguetes &gt;&gt;</a></td>
              <td bgcolor="#DBE6F0" class="rubros_articulos"><a href="articulos.php?rubro=joyasyrelojes">Joyas y Relojes &gt;&gt;</a></td>
              <td bgcolor="#DBE6F0" class="rubros_articulos"> <a href="articulos.php?rubro=varios">Varios &gt;&gt;</a></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td height="60" bgcolor="#FFFFFF"><a href="articulos.php" class="rubros">Ver Ultimas Publicaciones &gt;&gt; </a></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="100" align="center">
                      ...
                      <img src="../fotos-clasificados/articulos/thumbs/<?php echo $row_Recordset1['articulos_id']; ?>.jpg" width="70" height="70" hspace="2" vspace="2" />
                      <?php } else {?>
                      <img src="../fotos-clasificados/sin_imagen.jpg" width="70" height="70" hspace="2" vspace="2" />                      <?php }  ?>                    </td>
                    <td width="387" valign="top"><div><span class="fecha_anuncio"><?php echo $row_Recordset1['fecha']; ?></span><span class="texto_opciones"> -</span> <span class="titulo_anuncios"><?php echo $row_Recordset1['nombre']; ?></span> - <span class="texto_opciones">Rubro : <?php echo $row_Recordset1['rubro']; ?></span></div>
                <div class="texto_anuncio"><?php echo ucfirst($row_Recordset1['anuncio']); ?></div>
                <div class="rubros">
                  <div align="right"><a href="articulos_detalles.php?articulos_id=<?php echo $row_Recordset1['articulos_id']; ?>">+ ampliar &gt;&gt; </a></div>
                </div>
                <div class="texto_anuncio"></div></td>
                  </tr>
                </table>
              </div>
        ...
        <tr>
          <td><div align="right"><a href="#" onclick="abrirpopup('../sistema/guardar_anuncio.php?anuncio_id=<?php echo $row_Recordset1['articulos_id']; ?>&amp;&amp;base_datos=articulos',450,450)"><img src="../iconos/agrega_favoritos.jpg" alt="Agregar a favoritos" width="25" height="25" border="0" title="Agregue Anuncio a Anuncios Guardados" /></a> <a  href="#" onclick="abrirpopup('../sistema/imprimir_ficha.php?anuncio_id=<?php echo $row_Recordset1['articulos_id']; ?>&amp;&amp;base_datos=articulos',450,500)"><img src="../iconos/imprimir.png" alt="Imprimir anuncio" width="25" height="25" border="0"  title="Imprima Anuncio" /></a><a  href="#" onclick="abrirpopup('../sistema/enviarxemail.php?anuncio_id=<?php echo $row_Recordset1['articulos_id']; ?>&amp;&amp;base_datos=articulos',450,600)"><img src="../iconos/email-enviar.png" alt="Enviar por Mail" width="30" height="30" border="0" /></a></div></td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
