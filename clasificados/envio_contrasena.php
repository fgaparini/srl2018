...
if (isset($_POST['email'])) {
  $email_Recordset2 = (get_magic_quotes_gpc()) ? $_POST['email'] : addslashes($_POST['email']);
}
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset2 = sprintf("SELECT * FROM usuarios WHERE %s = '%s'", $email_Recordset2,$email_Recordset2);
...
<title>Tu contrase&ntilde;a en  Clasificados SRL || San Rafael ||</title>
...
<table width="859" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	$asunto = 'Tu contraseña, la olvidaste? ';
	$mailsrl = 'francogasparini@sanrafaellate.com.ar';
	$message = '
	  
	  
<font color="#FF0000" style="font:Arial, Helvetica, sans-serif "size="+4" > <b>:: SRL CLASIFICADOS ::</font> lo que necesitabas...<b> <br />

<b>Datos del Usuario:</b> <br />

      <b>Nombre:</b> $row_Recordset2["nombre_usuario"] <br />
	  
	  <b>Usuario:</b> $row_Recordset2["usuario"] <br />

      <b>E-Mail:</b> $row_Recordset2["email"] <br />

Tu contraseña es <b><font color="#FF0000" style="font:Arial, Helvetica, sans-serif "size="+2" > $row_Recordset2["contrasena"]</font></b>
...
$mail->From = 'soporte@srlclasificados.com.ar';
$mail->AddReplyTo ('soporte@srlclasificados.com.ar');
$mail->Subject = $asunto;
...
if (! $result) 
   print $error;  
    ...
    ?>
          <td colspan="2" class="titulos_seccion">Envio Contrase&ntilde;a </td>
        </tr>
        <tr>
          <td height="32" colspan="2" bgcolor="#FFFFFF"><div align="left">
            <div class="texto_opciones">Se te envio tu contrase&ntilde;a al email, <?php echo $email ; ?>, ingresa a tu cuenta de usuario, <a href="micuenta.php">INGRESAR &gt;&gt;</a> </div>
          </div></td>
        </tr>
        <tr>
