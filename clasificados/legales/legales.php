...
$query_Recordset4 = "SELECT * FROM usuarios";
...
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset2 = "SELECT * FROM profesionales GROUP BY fecha ORDER BY fecha ASC";
...
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset3 = "SELECT * FROM profesionales GROUP BY fecha ORDER BY fecha ASC";
...
$query_Recordset1 = "SELECT * FROM legales WHERE fecha BETWEEN '$fecha1' AND '$fecha2' ORDER BY fecha DESC" ; }
else { if (isset($_GET['Submit2'])) { 
$query_Recordset1 = "SELECT * FROM legales WHERE rubro LIKE '%$rubro2%'  " ; }
else {
$query_Recordset1 = "SELECT * FROM legales ORDER BY fecha ASC"; } }
...
<title>Legales, Judiciales  en San Rafael || Clasificados SRL || San Rafael || </title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<meta name="description" lang="es" content="Clasificados SRL :: Clasificados en San Rafael ::Legales y Judiciales en San Rafael, judicales, sucesorios, remates, quiebras y mucho mas en tu CLASIFICADOS EN SAN RAFAEL.. clasificados.sanrafaellate.com.ar "/>
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td colspan="3" class="titulos_seccion">Legales</td>
        </tr>
        <tr></tr>
        <tr>
        ...
        <tr>
          <td width="64%" bgcolor="#C2D1E7" class="contenedor_buscador"><form id="form1" name="form1" method="get" action="../empleos/empleos.php">
...
<br/>
          ...
          <td width="36%" rowspan="5" align="center" valign="top" bgcolor="#FFFFFF"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="190" height="190" hspace="2" vspace="2" title="San Rafael Late">
        ...
        <tr>
          <td height="69" bgcolor="#FFFFFF"><form action="../profesionales/legales.php" method="get" name="form2" class="texto_opciones" id="form2">
            <div align="left"><strong>&nbsp; <span class="texto_anuncio">Buscar por Rubros&gt;&gt;</span></strong>
                <span class="texto_anuncio">
                <select name="rubro" class="texto_anuncio" id="rubro">
                  <option value="judiciales" selected="selected">Judiciales</option>
                  <option value="sucesorios">Sucesorios</option>
                  <option value="remates">Remates</option>
                  <option value="quiebras">Quiebras</option>
                  <option value="citaciones">Citaciones - Notificaciones</option>
                  <option value="mensuras">Mensuras</option>
                </select>
               
                <input name="Submit2" type="submit" class="texto_anuncio" value="Enviar" />
                </span></div>
          </form></td>
        </tr>
        <tr>
        ...
        <tr>
          <td bgcolor="#FFFFFF"><div align="left" class="texto_rubros">Total de anuncios publicados: <?php echo $totalRows_Recordset1 ?> </div></td>
        </tr>
        <tr>
		  ...
		  <?php do { ?>
              <div class="contenedor_anuncios">
                ...
                <div class="texto_anuncio">
                  <div align="right"><a href="#" onclick="abrirpopup('../sistema/guardar_anuncio.php?anuncio_id=<?php echo $row_Recordset1['legales_id']; ?>&&base_datos=legales',400,600)"><img src="../iconos/agrega_favoritos.jpg" alt="Agregar a favoritos" width="25" height="25" border="0" title="Agregue Anuncio a Anuncios Guardados" /></a> <a  href="#" onclick="abrirpopup('../sistema/imprimir_ficha.php?anuncio_id=<?php echo $row_Recordset1['legales_id']; ?>&&base_datos=legales',450,600)"><img src="../iconos/imprimir.png" alt="Imprimir anuncio" width="25" height="25" border="0"  title="Imprima Anuncio" /></a><a  href="#" onclick="abrirpopup('../sistema/enviarxemail.php?anuncio_id=<?php echo $row_Recordset1['legales_id']; ?>&&base_datos=legales',450,600)"><img src="../iconos/email-enviar.png" alt="Enviar por Mail" width="30" height="30" border="0" /></a></div>
                </div>
              </div>
      ...
      <div >
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td class="rubros"><a href="legales.php">Legales</a></td>
