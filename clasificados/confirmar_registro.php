  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="RUBRO_TITULOS"><span class="titulos_seccion">BIENVENIDO A</span> <span class="Estilo2">SRL CLASIFICADOS </span></td>
        </tr>
        <tr>
          <td bgcolor="#FFFFFF"><div align="left">
              <div class="texto_opciones">Se ha registrado correctamente. Para iniciar Sesion y comenzar a usar todas las herramientas de <span class="titulo_anuncios">SRL CLASIFICADOS</span> ingrese en el formulario de abajo su <strong>usuario y contrase&ntilde;a. </strong></div>
          </div></td>
        </tr>
        <tr>
        ...
        <tr>
          <td align="left"><form action="<?php echo $loginFormAction; ?>" id="form2" name="form2" method="POST">
