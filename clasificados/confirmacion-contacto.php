...
<title>Confirmacion de Contacto|| Clasificados SRL || San Rafael ||</title>

<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<meta name="description" lang="es" content="Clasificados SRL :: Clasificados en San Rafael :: Inmuebles, automotores, legales educacionales, profesionales.. clasificados.sanrafaellate.com.ar "/>
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="titulos_seccion">Confirmacion de Contacto</td>
        </tr>
        <tr>
		  <?php
    $nombre = $_POST['nombre'];
...
<b>Consulta  Clasificados SAN RAFAEL LATE<b><br />
...
$mail->Subject = $asunto;
$mail->AddAddress('contacto@srlclasificados.com.ar', ' Clasificados SRL');
$mail->AddBCC("$mailsrl");
...
if (! $result) 
   print $error;  
    ...
    ?>
          <td height="46" bgcolor="#FFFFFF" class="texto_opciones"><p><span class="texto_opciones">Estimado </span><span class="texto_verde"><strong><?php echo $nombre ; ?> </strong></span>, gracias por ponerse en contacto con nosotros a la brevedad nos pondremos en contacto con Ud. Lo invitamos a continuar navegando en el sitio. </p>
            <p align="right">Saludos Cordiales <br />
            <span class="sos_nuevo"><strong>SRL CLASIFICADOS</strong></span> </p></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
