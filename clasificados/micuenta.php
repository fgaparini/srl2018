...
<title>Entrar a mi cuenta || Clasificados SRL || San Rafael ||</title>
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="titulos_seccion"> LOGIN Usuario </td>
        </tr>
        <tr>
          <td bgcolor="#FFFFFF"><div align="left">
            <div class="texto_opciones">Ingresa a tu cuenta en <span class="sos_nuevo">SRL CLASIFICADOS</span> </div>
          </div></td>
        </tr>
        <tr>
        ...
        <tr>
          <td align="left" class="contenedor_anuncios"><form action="<?php echo $loginFormAction; ?>" id="form3" name="form3" method="POST">
            <table width="300" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666">
              <tr>
                <td><table width="300" height="113" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                  ...
                  <tr>
                    ...
                    <td height="30" rowspan="2" align="right" valign="middle" bgcolor="#FFFFFF" class="menu_superior"><label></label>
                        <div align="center">
                          <label>
                          <input name="Submit22" type="submit" class="rubros_articulos" value="entrar" />
                          </label>
                      </div></td>
                  </tr>
                  <tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div align="center">
            <form id="form3" name="form3" method="post" action="olvide_contrasena.php">
              <table width="50%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000033">
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="28" colspan="2" bgcolor="#000033" class="sos_nuevo">OLVIDASTE TU CONTRASE&Ntilde;A? </td>
                      </tr>
                      <tr>
                        <td height="8" colspan="2" bgcolor="#D9D9FF">&nbsp;</td>
                      </tr>
                      <tr>
                        <td width="28%" bgcolor="#D9D9FF" class="texto_negro">Usuario:
                          <label></label></td>
                        <td width="72%" bgcolor="#D9D9FF" class="texto_negro"><input name="textfield" type="text" size="25" /></td>
                      </tr>
                      <tr>
                        <td height="8" colspan="2" bgcolor="#D9D9FF" class="texto_negro"></td>
                      </tr>
                      <tr>
                        <td bgcolor="#D9D9FF" class="texto_negro">Email :
                          <label></label></td>
                        <td bgcolor="#D9D9FF" class="texto_negro"><input name="textfield2" type="text" size="25" /></td>
                      </tr>
                      <tr>
                        <td height="8" colspan="2" bgcolor="#D9D9FF" class="texto_anuncio"></td>
                      </tr>
                      <tr>
                        <td height="44" colspan="2" bgcolor="#D9D9FF"><div align="center">
                            <label>
                            <input name="Submit" type="submit" class="texto_negro" value="Enviar" />
                            </label>
                        </div></td>
                      </tr>
                  </table></td>
