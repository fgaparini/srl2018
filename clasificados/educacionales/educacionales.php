...
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset2 = "SELECT * FROM educacionales GROUP BY fecha ORDER BY fecha ASC";
...
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset3 = "SELECT * FROM educacionales GROUP BY fecha ORDER BY fecha ASC";
...
$query_Recordset1 = "SELECT * FROM educacionales WHERE fecha BETWEEN '$fecha1' AND '$fecha2' ORDER BY fecha DESC" ; }
else { if (isset($_GET['rubro2'])) { 
$query_Recordset1 = "SELECT * FROM educacionales WHERE rubro LIKE '%$rubro2%'  " ; }
else {
$query_Recordset1 = "SELECT * FROM educacionales ORDER BY fecha ASC"; } }
...
<title>Educacionales en San Rafael || Clasificados SRL || San Rafael || </title>

<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<meta name="description" lang="es" content="Clasificados SRL :: Clasificados en San Rafael :: Educacionales en San Rafael, citaciones, cursos y conferencias, pedidos laboral, informacion en general CLASIFICADOS EN SAN RAFAEL.. clasificados.sanrafaellate.com.ar "/>
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td colspan="3" class="titulos_seccion">Educacionales</td>
        </tr>
        <tr>
          <td colspan="3">&nbsp;</td>
        </tr>
        <tr>
          <td width="64%" bgcolor="#C2D1E7" class="contenedor_buscador"><form id="form1" name="form1" method="get" action="educacionales.php">
...
<br/>
        ...
        <tr>
          <td height="69" bgcolor="#FFFFFF"><form action="educacionales.php" method="get" name="form2" class="texto_opciones" id="form2">
            <div align="left"><strong>&nbsp; Buscar por Rubros&gt;&gt;</strong>
              <select name="rubro2" class="texto_anuncio" id="rubro2">
                <option value="citaciones">Citaciones</option>
                <option value="laboral">Laboral</option>
                <option value="especialidades">Especialidades</option>
                <option value="comunicados">Comunicados</option>
                <option value="cursos">Cursos y Conferencias</option>
                <option value="info-general">Informacion General</option>
		  ...
		  <?php do { ?>
              <div class="contenedor_anuncios">
                ...
                <div class="texto_anuncio">
                  <div align="right"><a href="#" onclick="abrirpopup('../sistema/guardar_anuncio.php?anuncio_id=<?php echo $row_Recordset1['educacionales_id']; ?>&&base_datos=educacionales',450,450)"><img src="../iconos/agrega_favoritos.jpg" alt="Agregar a favoritos" width="25" height="25" border="0" title="Agregue Anuncio a Anuncios Guardados" /></a> <a  href="#" onclick="abrirpopup('../sistema/imprimir_ficha.php?anuncio_id=<?php echo $row_Recordset1['educacionales_id']; ?>&&base_datos=educacionales',450,500)"><img src="../iconos/imprimir.png" alt="Imprimir anuncio" width="25" height="25" border="0"  title="Imprima Anuncio" /></a><a  href="#" onclick="abrirpopup('../sistema/enviarxemail.php?anuncio_id=<?php echo $row_Recordset1['educacionales_id']; ?>&&base_datos=educacionales',450,600)"><img src="../iconos/email-enviar.png" alt="Enviar por Mail" width="30" height="30" border="0" /></a></div>
                </div>
              </div>
      ...
      <div >
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td class="rubros"><a href="educacionales.php">Educacionales</a></td>
          </tr>
          <tr>
