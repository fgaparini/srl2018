  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td colspan="2" class="titulos_seccion">Pagina Restringida </td>
        </tr>
        <tr>
          <td colspan="2" bgcolor="#FFFFFF"><div align="left">
              <div class="texto_opciones">La pagina a la quiso acceder esta restringida para usuarios de <span class="sos_nuevo">SRL CLASIFICADOS</span>, si ya estas registrado Inicia Session, en caso de que no lo estes, puedes <strong>Registrarte Gratis!!</strong> </div>
          </div></td>
        </tr>
        <tr>
        ...
        <tr>
                  ...
                  <td height="27" colspan="3" align="center" valign="middle" class="rubros_articulos_seleccionado"><div align="left">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="81%">Mi cuenta - Ingesar </td>
                        </tr>
                      </table>
                  </div></td>
                </tr>
          ...
          <td><form id="form2" name="form2" method="post" action="registro_usuarios.php">
              <div align="center">
                <table width="90%" height="54%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#E6E9D8">
                  <tr>
                    <td height="140"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FF6600" bgcolor="#FFCC99">
                        <tr>
                          <td height="29" bgcolor="#BBCF8D" class="menu_superior style1"><div align="center" class="style2">NO ESTAS REGISTRADO!! </div></td>
                        </tr>
                        <tr>
                          <td bgcolor="#BBCF8D"><div class="registrateCopy">Registrate en <strong>SRL CALSIFICADOS</strong> es TOTALMENTE GRATIS !! NO pierdas mas Tiempo.</div></td>
                        </tr>
                        <tr>
                          <td bgcolor="#BBCF8D">&nbsp;</td>
                        </tr>
                        <tr>
                          <td bgcolor="#BBCF8D"><div align="center">
                              <label>
                              <input name="Submit" type="submit" class="registrate" value="REGISTRATE !!" />
                              </label>
                          </div></td>
                        </tr>
                        <tr>
