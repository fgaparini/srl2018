...
$query_Recordset1 = "SELECT * FROM profesionales WHERE fecha BETWEEN '$fecha1' AND '$fecha2' ORDER BY fecha DESC" ; }
else { if (isset($_GET['rubro2'])) { 
$query_Recordset1 = "SELECT * FROM profesionales WHERE rubro LIKE '%$rubro2%'  " ; }
else {
$query_Recordset1 = "SELECT * FROM profesionales ORDER BY fecha ASC"; } }
...
<title>Guia de Profesionales en San Rafael || Clasificados SRL || San Rafael || </title>

<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<meta name="description" lang="es" content="Clasificados SRL :: Clasificados en San Rafael :: Guia de Profesionales en San Rafael, Ingeniero, medicos, abogados, contadores, licenciados.. CLASIFICADOS EN SAN RAFAEL.. clasificados.sanrafaellate.com.ar "/>
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td colspan="3" class="titulos_seccion">Profesionales</td>
        </tr>
        <tr></tr>
        <tr>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','190','height','190','hspace','2','vspace','2','title','San Rafael Late','src','../publicidad/publi_next_buscador','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','../publicidad/publi_next_buscador' ); //end AC code
        ...
        <tr>
          <td height="69" bgcolor="#FFFFFF"><form action="../educacionales/educacionales.php" method="get" name="form2" class="texto_opciones" id="form2">
            <div align="left"><strong class="texto_anuncio">&nbsp;</strong><strong> Buscar por Rubros&gt;&gt;</strong>
              <select name="rubro" class="texto_anuncio" id="rubro">
                <option value="exactas">Ciencias Exactas</option>
                <option value="medicas">Ciencia Medicas</option>
                <option value="economicas">Ciencias Economicas</option>
                <option value="humanas">Ciencias Humanas</option>
                <option value="juridicas">Ciencias juridicas</option>
              </select>
		  ...
		  <?php do { ?>
              <div class="contenedor_anuncios">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="100" align="center"><?php if ($row_Recordset1['imagen'] != NULL) {?>
                        <img src="../fotos-clasificados/profesionales/thumbs/<?php echo $row_Recordset1['articulos_id']; ?>.jpg" width="70" height="70" hspace="2" vspace="2" />
                        <?php } else {?>
                    ...
                    <td width="387" valign="top"><div><span class="fecha_anuncio"><?php echo $row_Recordset1['fecha']; ?></span><span class="texto_opciones"> -</span> <span class="titulo_anuncios"><?php echo $row_Recordset1['nombre']; ?></span> - <span class="texto_opciones">Rubro : <?php echo $row_Recordset1['rubro']; ?></span></div>
                      ...
                      <div class="rubros">
                          <div align="right"><a href="profesionales_detalles.php?profesionales_id=<?php echo $row_Recordset1['profesionales_id']; ?>">+ ampliar &gt;&gt; </a></div>
                      </div>
