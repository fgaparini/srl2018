...
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset3 = sprintf("SELECT * FROM preguntas WHERE clasificado_id = %s AND preguntas.tipo_clasi = 'profesionales'", GetSQLValueString($colname_Recordset3, "text"));
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr></tr>
        <tr>
          <td class="rubros"><a href="../articulos/articulos.php">Articulos &gt;&gt;</a> <a href="../articulos/articulos.php?rubro=<?php echo $row_Recordset1['rubro']; ?>"><?php echo $row_Recordset1['rubro']; ?>&gt;&gt;</a></td>
        </tr>
        <tr>
          ...
          <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="231" valign="top" class="linea_detalles"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="texto_opciones"><?php echo $row_Recordset2['anuncio']; ?></td>
                </tr>
              </table></td>
            </tr>
          </table></td>
      ...
      <div >
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="46%" class="rubros"><a href="profesionales.php">Guia de Profesionales </a></td>
          </tr>
          <tr>
