...
if (isset($_POST['usuario'])) {
  ...
  $MM_redirectLoginSuccess = "empleos/sistema/index.php";
  $MM_redirectLoginFailed = "empleos/registro.php";
...
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset2 = "SELECT * FROM empleos GROUP BY fecha ORDER BY fecha ASC";
...
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset3 = "SELECT * FROM empleos GROUP BY fecha ORDER BY fecha ASC";
...
<title>Contacto || Clasificados SRL || San Rafael ||</title>

<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<meta name="description" lang="es" content="Clasificados SRL :: Clasificados en San Rafael :: Inmuebles, automotores, legales educacionales, profesionales.. clasificados.sanrafaellate.com.a"/>
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="titulos_seccion">Contacto</td>
        </tr>
        <tr>
          <td height="46" bgcolor="#FFFFFF" class="texto_opciones">Complete el siguiente formulario y dejenos su consulta unos de nuestro operadores le responder&aacute; a la brevedad </td>
        </tr>
        <tr>
          <td><form id="form1" name="form1" method="post" action="confirmacion-contacto.php">
            <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="24" colspan="2" class="texto_formulario"><div align="left"></div></td>
              </tr>
              <tr>
                <td width="24%" class="texto_verde">Nombre * </td>
                <td width="76%"><div align="left">
                    <input name="nombre" id="nombre" type="text" />
                </div></td>
              </tr>
              <tr>
                <td class="texto_verde">Apellido * </td>
                <td><div align="left">
                    <input name="apellido" id="apellido" type="text" />
                </div></td>
              </tr>
              <tr>
                <td class="texto_verde">Telefono * </td>
                <td><div align="left">
                    <input name="telefono" id="telefono" type="text" />
                </div></td>
              </tr>
              <tr>
                <td class="texto_verde">Pais</td>
                <td><div align="left">
                    <input name="pais" id="pais" type="text" />
                </div></td>
              </tr>
              <tr>
                <td class="texto_verde">Ciudad</td>
                <td><div align="left">
                    <input name="ciudad" id="ciudad" type="text" />
                </div></td>
              </tr>
              <tr>
                <td class="texto_verde">Domicilio </td>
                <td><div align="left">
                    <input name="direccion" id="direccion" type="text" />
                </div></td>
              </tr>
              <tr>
                <td class="texto_verde">E-Mail * </td>
                <td><div align="left">
                    <input name="email" id="email" type="text" />
                </div></td>
              </tr>
              <tr>
                <td class="texto_verde">Asunto * </td>
                <td><div align="left">
                    <input name="asunto" id="asunto" type="text" />
                </div></td>
              </tr>
              <tr>
                <td class="texto_verde">Consulta * </td>
                <td><div align="left">
                    <textarea name="consulta" cols="30" rows="5" id="consulta"></textarea>
                </div></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><input name="Restablecer" id="Restablecer" value="Restablecer" type="reset" />
