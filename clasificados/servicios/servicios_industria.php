...
$query_Recordset1 = "SELECT * FROM servicios WHERE subrubro LIKE '%$subrubro%'  AND rubro LIKE  '%industria%'  ORDER BY servicios.servicios_id DESC";}
else {
$query_Recordset1 = "SELECT * FROM servicios WHERE rubro LIKE '%industria%' ORDER BY servicios.servicios_id DESC";}
...
<title>Servicios de Educacion en San Rafael || Ofrecimientos || Empresas || San Rafael</title>
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="30" bgcolor="#FFFFFF" class="texto_opciones"><span class="rubros_articulos_seleccionado">Educacion  &gt;&gt; </span></td>
        </tr>
        <tr></tr>
        <tr>
          <td height="60" bgcolor="#FFFFFF"><form action="servicios_industria.php" method="post" name="form2" class="texto_opciones" id="form2">
            <div align="left"><strong class="texto_anuncio">&nbsp;</strong><strong> Buscar por servicio &gt;&gt;</strong>
                <select name="subrubro" class="texto_opciones" id="subrubro">
                  <option value="diseno-web">Diseño Web / Grafica</option>
                  <option value="contenedores">Contenedores</option>
                  <option value="limpieza">Limpieza</option>
                  <option value="desifeccion">desifeccion</option>
                  <option value="Impreta">Imprenta</option>
