...
$query_Recordset1 = "SELECT * FROM servicios WHERE subrubro LIKE '%$subrubro%'  AND rubro LIKE  '%educacion%'  ORDER BY servicios.servicios_id DESC";}
else {
$query_Recordset1 = "SELECT * FROM servicios WHERE rubro LIKE '%educacion%' ORDER BY servicios.servicios_id DESC";}
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr></tr>
        <tr>
          <td height="60" bgcolor="#FFFFFF"><form action="servicios_educacion.php" method="post" name="form2" class="texto_opciones" id="form2">
            <div align="left"><strong class="texto_anuncio">&nbsp;</strong><strong> Buscar por servicio &gt;&gt;</strong>
                <select name="subrubro" class="texto_opciones" id="subrubro">
                  <option value="preparacion-alumnos">Preparacion Alumnos</option>
                  <option value="academias">Academias Institutos</option>
