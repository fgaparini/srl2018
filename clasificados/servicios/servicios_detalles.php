...
if (isset($_GET['servicios_id'])) {
  $colname_Recordset1 = $_GET['servicios_id'];
}
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset1 = sprintf("SELECT * FROM servicios WHERE servicios_id = %s", GetSQLValueString($colname_Recordset1, "int"));
$Recordset1 = mysql_query($query_Recordset1, $clasificados) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);

mysql_select_db($database_clasificados, $clasificados);
$query_Recordset2 = "SELECT * FROM usuarios, articulos WHERE usuarios.id_usuario =  articulos.id_usuario";
$Recordset2 = mysql_query($query_Recordset2, $clasificados) or die(mysql_error());
$row_Recordset2 = mysql_fetch_assoc($Recordset2);
$totalRows_Recordset2 = mysql_num_rows($Recordset2);

$id_tutu_Recordset3 = "-1";
if (isset($_GET['autos_id'])) {
  $id_tutu_Recordset3 = $_GET['autos_id'];
}
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset3 = sprintf("SELECT * FROM preguntas WHERE preguntas.clasificado_id = %s ORDER BY preguntas.fecha_pregunta ASC", GetSQLValueString($id_tutu_Recordset3, "int"));
...
<title><?php echo $row_Recordset1['nombre']; ?>|| Servicios en San Rafael || <?php echo $row_Recordset1['rubro']; ?> || Clasificados SRL || San Rafael || </title>
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="rubros"><a href="../index.php">Inicio&gt;&gt;</a> <a href="servicios.php">Servicios&gt;&gt;</a></td>
        </tr>
        <tr>
        ...
        <tr>
          <td bgcolor="#FFFFFF"><div align="right">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea_detalles">
              <tr>
                <td width="3%">&nbsp;</td>
                <td width="57%" valign="middle"><div align="right"><a href="#" onclick="abrirpopup('../sistema/guardar_anuncios_servicios.php?anuncio_id=<?php echo $row_Recordset1['educacionales_id']; ?>&amp;&amp;base_datos=servicios',450,450)"><img src="../iconos/agrega_favoritos.jpg" alt="Agregar a favoritos" width="25" height="25" border="0" title="Agregue Anuncio a Anuncios Guardados" /></a><a href="#" onclick="abrirpopup('../sistema/guardar_anuncios_servicios.php?anuncio_id=<?php echo $row_Recordset1['educacionales_id']; ?>&amp;&amp;base_datos=servicios',450,450)"></a><a href="#" onclick="abrirpopup('../sistema/guardar_anuncios_auto.php?anuncio_id=<?php echo $row_Recordset1['autos_id']; ?>',450,450)"><span class="texto_link_chico">Guardar para seguimiento</span></a></div></td>
                <td width="4%" valign="middle">&nbsp;</td>
                <td width="14%" valign="middle"><div align="left"><span class="texto_link_chico"><a href="#" onclick="abrirpopup('../sistema/guardar_anuncio.php?anuncio_id=<?php echo $row_Recordset1['articulos_id']; ?>&amp;&amp;base_datos=articulos',450,450)"> </a></span><a  href="#" onclick="abrirpopup('../sistema/imprimir_anuncio_servicios.php?anuncio_id=<?php echo $row_Recordset1['educacionales_id']; ?>&amp;&amp;base_datos=servicios',450,500)"><img src="../iconos/imprimir.png" alt="Imprimir anuncio" width="25" height="25" border="0"  title="Imprima Anuncio" /></a><a  href="#" onclick="abrirpopup('../sistema/imprimir_anuncio_auto.php?anuncio_id=<?php echo $row_Recordset1['autos_id']; ?>',450,500)"><span class="texto_link_chico">i</span></a><a  href="#" onclick="abrirpopup('../sistema/imprimir_anuncio_auto.php?anuncio_id=<?php echo $row_Recordset1['autos_id']; ?>',450,500)"><span class="texto_link_chico">mprimir</span></a></div></td>
                <td width="2%" valign="middle">&nbsp;</td>
                <td width="20%" valign="middle"><div align="left"><a  href="#" onclick="abrirpopup('../sistema/enviarxemail_servicios.php?anuncio_id=<?php echo $row_Recordset1['educacionales_id']; ?>&amp;&amp;base_datos=servicios',450,600)"><img src="../iconos/email-enviar.png" alt="Enviar por Mail" width="30" height="30" border="0" /></a><a  href="#" onclick="abrirpopup('../sistema/enviarxemail_auto.php?anuncio_id=<?php echo $row_Recordset1['autos_id']; ?>',450,600)"><span class="texto_link_chico">enviar a un amigo</span></a></div></td>
              </tr>
            </table>
          </div></td>
        </tr>
        <tr>
          <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="46%" height="15" rowspan="2" valign="top" class="division_detalles_fotos"><?php if ($row_Recordset1['imagen'] != NULL) { ?><a href="../fotos-clasificados/automotores/<?php echo $row_Recordset1['autos_id']; ?>.jpg" rel="lightbox[fotos]"><img src="../fotos-clasificados/servicios/<?php echo $row_Recordset1['servicios_id']; ?>.jpg" width="250" height="230" hspace="2" vspace="2" /></a>
                <?php } else {?>
              ...
              <td width="54%" valign="top" class="contenedor_opciones"><table width="97%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="106" height="40" bgcolor="#F9F9F9" class="texto_negro"><strong>Precio:</strong></td>
                  <td width="157" bgcolor="#F9F9F9" class="textoguias">$<?php echo $row_Recordset1['precio']; ?></td>
                </tr>
                
                <tr>
                  <td width="106" class="texto_negro"><strong>Publicado el:</strong></td>
                  <td class="texto_opciones"><?php echo $row_Recordset1['fecha']; ?></td>
                </tr>
                <tr>
                  <td class="texto_negro"><strong>Id:</strong></td>
                  <td class="texto_opciones"><span class="texto_opciones"><?php echo $row_Recordset1['autos_id']; ?></span></td>
                </tr>
                <tr>
                  <td width="106" class="texto_negro"><strong>Subrubro:</strong></td>
                  <td class="texto_opciones"><span class="texto_opciones"><?php echo $row_Recordset1['tipo']; ?></span></td>
                </tr>
                <tr>
                  <td width="106" class="texto_negro">&nbsp;</td>
                  <td class="texto_negro">&nbsp;</td>
                </tr>
                <tr>
                  <td width="106" class="linea_detalles">&nbsp;</td>
                ...
                <tr>
                  <td width="106" bgcolor="#F9F9F9" class="texto_negro"><span class="style2">Empresa:</span></td>
                  <td bgcolor="#F9F9F9" class="texto_opciones"><strong><?php echo $row_Recordset2['empresa']; ?></strong></td>
                </tr>
                <tr>
                  <td width="106" bgcolor="#F9F9F9" class="texto_negro"><span class="style2">Direccion:</span></td>
                  <td bgcolor="#F9F9F9" class="texto_opciones"><strong><?php echo $row_Recordset2['direccion']; ?></strong></td>
                </tr>
                <tr>
                  <td width="106" bgcolor="#F9F9F9" class="linea_detalles">&nbsp;</td>
                  <td bgcolor="#F9F9F9" class="linea_detalles">&nbsp;</td>
                </tr>
              </table></td>
            </tr>
            <tr>
              <td height="148" valign="top" class="linea_detalles"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="texto_panel">Descripcion</td>
                </tr>
                <tr>
                  <td class="texto_opciones"><?php echo $row_Recordset1['anuncio']; ?><br /></td>
                </tr>
              </table></td>
            </tr>
          </table></td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><div align="center">
              <p class="texto_anuncio"><a href="#" class="texto_link_chico" onclick="abrirpopup('../sistema/hacer_pregunta.php?clasi_id=<?php echo $row_Recordset1['servicios_id']; ?>&&tipo_clasi=servicios&&usuario_art_id=<?php echo $row_Recordset2['id_usuario']; ?>',600,450)"><strong>Hacer Pregunta</strong> (solo usuarios registrados) &gt;&gt;</a></p>
          </div></td>
        </tr>
        <tr>
      ...
      <p align="center"><span class="texto_link_chico"><a href="#" onclick="abrirpopup('../sistema/hacer_pregunta.php?clasi_id =<?php echo $row_Recordset1['autos_id']; ?>&&tipo_clasi=autos&&usuario_art_id=<?php echo $row_Recordset1['usuario_id']; ?>',600,450)"><strong>Hacer Pregunta</strong> (solo usuarios registrados) &gt;&gt;</a></span></p>
      <p>&nbsp;</p>
      ...
      <div >
        ...
        <form id="form2" name="form2" method="POST" action="../login.php">
          <table width="97%" height="113" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="19" colspan="3" valign="top" bgcolor="#FFFFFF" class="texto_anuncio"><span class="texto_link_chico"><a href="../autos_san_rafael/olvide_contrase&ntilde;a.php">olvidaste tu contrase&ntilde;a ?</a> -<a href="../registro.php"> Registrate Aqui &gt;&gt;</a><a href="#"></a></span> </td>
            </tr>
          </table>
            </form><?php } ?>
        <p>&nbsp;</p>
