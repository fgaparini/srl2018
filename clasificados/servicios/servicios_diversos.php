...
$query_Recordset1 = "SELECT * FROM servicios WHERE subrubro LIKE '%$subrubro%'  AND rubro LIKE  '%varios%'  ORDER BY servicios.servicios_id DESC";}
else {
$query_Recordset1 = "SELECT * FROM servicios WHERE rubro LIKE '%varios%' ORDER BY servicios.servicios_id DESC";}
...
<title>Servicios Diversos  en San Rafael || Ofrecimientos || Empresas || San Rafael</title>
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="30" bgcolor="#FFFFFF" class="texto_opciones"><span class="rubros_articulos_seleccionado">Varios&gt;&gt; </span></td>
        </tr>
        <tr></tr>
        <tr>
          <td height="60" bgcolor="#FFFFFF"><form action="servicios_diversos.php" method="post" name="form2" class="texto_opciones" id="form2">
