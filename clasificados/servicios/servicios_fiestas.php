...
$query_Recordset1 = "SELECT * FROM servicios WHERE subrubro LIKE '%$subrubro%'  AND rubro LIKE  '%fiestas%'  ORDER BY servicios.servicios_id DESC";}
else {
$query_Recordset1 = "SELECT * FROM servicios WHERE rubro LIKE '%fiestas%' ORDER BY servicios.servicios_id DESC";}
...
<title>Servicios para Fiestas en San Rafael || Ofrecimientos || Empresas || San Rafael</title>
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="titulos_seccion"><a href="servicios.php" title="Volver Home Servicios">&lt;&lt; Servicios</a></td>
        </tr>
        <tr>
          <td height="30" bgcolor="#FFFFFF" class="texto_opciones"><span class="rubros_articulos_seleccionado">Fiestas   &gt;&gt; </span></td>
        </tr>
        <tr></tr>
        <tr>
          <td height="60" bgcolor="#FFFFFF"><form action="servicios_fiesta.php" method="post" name="form2" class="texto_opciones" id="form2">
            <div align="left"><strong class="texto_anuncio">&nbsp;</strong><strong> Buscar por servicio &gt;&gt;</strong>
                <select name="subrubro" class="texto_opciones" id="subrubro">
                  <option value="emp-org">Empresa de Organizacion</option>
                  <option value="salones">Salones</option>
                  <option value="infantiles">Infatiles</option>
                  <option value="catering">Catering</option>
                  <option value="cotillon">Cotillon</option>
                  <option value="musica-iluminacion">Musica e Iluminacion</option>
                  <option value="filmacionesyfotos">filmaciones y fotos</option>
        ...
        <tr>
		  ...
		  <?php do { ?>
              <div class="contenedor_anuncios">
                <div><span class="fecha_anuncio"><?php echo $row_Recordset1['fecha']; ?></span><span class="texto_opciones"> -</span> <span class="titulo_anuncios"><?php echo $row_Recordset1['nombre']; ?></span>-<span class="texto_opciones"><?php echo $row_Recordset1['rubro']; ?>-<?php echo $row_Recordset1['subrubro']; ?></span></div>
                <div class="texto_anuncio"><?php echo ucfirst($row_Recordset1['anuncio']); ?></div>
             <div class="texto_anuncio">
                  <div align="right"><a href="#" onclick="abrirpopup('../sistema/guardar_anuncios_servicios.php?anuncio_id=<?php echo $row_Recordset1['educacionales_id']; ?>&&base_datos=servicios',450,450)"><img src="../iconos/agrega_favoritos.jpg" alt="Agregar a favoritos" width="25" height="25" border="0" title="Agregue Anuncio a Anuncios Guardados" /></a> <a  href="#" onclick="abrirpopup('../sistema/imprimir_anuncio_servicios.php?anuncio_id=<?php echo $row_Recordset1['educacionales_id']; ?>&&base_datos=servicios',450,500)"><img src="../iconos/imprimir.png" alt="Imprimir anuncio" width="25" height="25" border="0"  title="Imprima Anuncio" /></a><a  href="#" onclick="abrirpopup('../sistema/enviarxemail_servicios.php?anuncio_id=<?php echo $row_Recordset1['educacionales_id']; ?>&&base_datos=servicios',450,600)"><img src="../iconos/email-enviar.png" alt="Enviar por Mail" width="30" height="30" border="0" /></a></div>
                </div> </div>
