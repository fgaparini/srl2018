  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="rubros_articulos"><div align="center"><a href="escribir_clasificado_inmuebles.php">Inmuebles</a></div></td>
          <td class="rubros_articulos"><div align="center"><a href="escribir_clasificado_auto.php">Automotores</a></div></td>
          <td class="rubros_articulos"><div align="center"><a href="escribir_clasificado.php">Otros ( empleos, legales, etc) </a></div></td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
