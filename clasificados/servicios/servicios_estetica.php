...
$query_Recordset1 = "SELECT * FROM servicios WHERE subrubro LIKE '%$subrubro%'  AND rubro LIKE  '%esteticos%'  ORDER BY servicios.servicios_id DESC";}
else {
$query_Recordset1 = "SELECT * FROM servicios WHERE rubro LIKE '%estetica%' ORDER BY servicios.servicios_id DESC";}
...
<title>Servicios de ESTETICOS en San Rafael || Ofrecimientos || Empresas || San Rafael</title>
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="30" bgcolor="#FFFFFF" class="texto_opciones"><span class="rubros_articulos_seleccionado">Esteticos &gt;&gt; </span></td>
        </tr>
        <tr></tr>
        <tr>
          <td height="60" bgcolor="#FFFFFF"><form action="servicios_estetica.php" method="post" name="form2" class="texto_opciones" id="form2">
            <div align="left"><strong class="texto_anuncio">&nbsp;</strong><strong> Buscar por servicio &gt;&gt;</strong>
                <select name="subrubro" class="texto_opciones" id="subrubro">
                  ...
                  <option value="centroesteticos">Centro Esteticos</option>
