  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="titulos_seccion">Como Publicar tu Fotoclasificado</td>
        </tr>
        <tr>
          <td bgcolor="#FFFFFF" class="texto_opciones">Para publicar un anuncio debes seguir los siguientes pasos <br />
          (la publicacion es GRATIS!!) :</td>
        </tr>
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td width="32%"><div align="center"><img src="imagenes/boton1" width="50" height="50" /></div></td>
              <td width="34%"><div align="center"><img src="imagenes/boton2" width="50" height="50" /></div></td>
              <td width="34%"><div align="center"><img src="imagenes/boton3" width="50" height="50" /></div></td>
              </tr>
            <tr>
              <td class="anuncio_curriculum"><div align="center"><a href="micuenta.php">ENTRA EN TU CUENTA</a>.<br />
                Debes <a href="registro_usuarios.php">REGISTRARTE</a> o estar registrado en <span class="texto_negro"><span class="Estilo7"><br />
                SRL</span> Clasificados.</span>l registro es totalmente gratis!!</div></td>
              <td class="anuncio_curriculum"><div align="center">En el panel de control ir a la seccion <strong>&quot;escribir anuncio&quot;</strong>. entrar y elegi el tipo de clasificado.</div></td>
              <td><div align="center" class="anuncio_curriculum">Rellena los campos del formulario , eligi la foto y hace clic en publicar. <br />
                  <strong>LISTO !!</strong> tu <strong class="textoguias">FOTOclasificado</strong> ya esta publicado.</div></td>
              </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
