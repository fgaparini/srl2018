  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="titulos_seccion">MI CUENTA &gt;&gt;<span class="RUBRO_TITULOS"> Escribir Anuncio </span></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><a href="<?php echo $logoutAction ?>"></a></td>
        </tr>
        <tr>
          <td width="39%"><form id="frm" name="frm" method="post" action="insertar.asp">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="33%">Seleccionar Categoria </td>
                <td width="6%">&nbsp;</td>
                <td width="61%"><select name="categoria" id="categoria" onchange="activaOtro();cambia(document.frm.rubro) ">
                  <option value="empleos">Empleos</option>
                  <option value="profesionales">Guia Profesionales</option>
                  <option value="legales">Legales</option>
                  <option value="educacionales" selected="selected">Educacionales</option>
                  <option value="articulos">Articulos</option>
                  <option value="servicios">Servicios</option>
                </select>                </td>
              </tr>
              <tr>
                <td height="39">Seleccionar Rubro </td>
                <td>&nbsp;</td>
                <td><select name="rubro" id="rubro" onchange="cambia2(document.frm.otro)">
              ...
              <tr>
                <td>Seleccionar Subrubro </td>
                <td>&nbsp;</td>
                <td><select name="otro" size="1" disabled="disabled" id="otro">
                  <option value="carpinteria">Carpinteria</option>
                  <option value="plomeria">Plomeria-Gasista</option>
                  <option value="construciones">construcciones </option>
                  <option value="jardineria">jardineria</option>
                  <option value="electricidad">Electricidad</option>
                  <option value="hartistica">Herreria Artistica</option>
                  <option value="mudanzas">Mudanzas</option>
                  <option value="repararelectro">Reparacion Electrodomesticos</option>
              ...
              <tr>
                <td height="40">Titulo</td>
                <td height="40">&nbsp;</td>
                <td height="40"><label>
                  <input name="tutulo" type="text" id="tutulo" size="30" />
                </label></td>
              </tr>
              <tr>
                <td height="40">Anuncio</td>
                <td height="40">&nbsp;</td>
                <td height="40"><textarea name="anuncio" cols="40" rows="8" id="anuncio"></textarea></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td><label>
                  <input type="submit" name="Submit" value="Publicar Anuncio" />
                </label></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
    ...
    <td valign="top" class="bordes_lateral_guias"><div class="guias_contenedor">
      ...
      <div >
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="29%" height="25" class="rubros"><div align="center"><a href="sistema/index.php"></a><a href="sistema/index.php"><img src="iconos/panel_control.jpg" alt="pANE cONTROL" width="30" height="30" border="0" /></a></div>
              <div align="center"><a href="sistema/index.php">Inicio Panel </a></div></td>
            <td width="44%" class="rubros"><div align="center"><a href="sistema/index.php"><img src="iconos/panel_escribir.jpg" alt="eSCRIBIR TU ANUNCIO CLASIFICADOS" width="30" height="30" border="0" /></a></div>
              <div align="center"><a href="sistema/publique_anuncio.php">escribir anuncio </a></div></td>
            <td width="27%" class="rubros">
              ...
              <div align="center"><a href="sistema/mis_anuncios.php">mis anuncios </a></div></td>
          </tr>
          <tr>
            <td class="rubros"><div align="center"><a href="sistema/mis_datos.php"><img src="iconos/mis-datos-C.png" alt="mis datos " width="30" height="30" border="0" /></a></div>
              <div align="center"><a href="sistema/mis_datos.php">mis datos </a></div></td>
            <td class="rubros"><div align="center"><a href="sistema/anuncios_guadados.php"><img src="iconos/anuncio-guardados.jpg" width="30" height="30" border="0" /></a></div>
              <div align="center"><a href="sistema/anuncios_guadados.php">anuncios guardados </a></div></td>
            <td class="rubros"><div align="center"><a href="sistema/agregar_curriculum.php"><img src="iconos/curriculum-C.png" alt="redata tu curriculum" width="30" height="30" border="0" /></a></div>
              <div align="center"><a href="sistema/agregar_curriculum.php">redactar curriculum </a></div></td>
          </tr>
        </table>
		<p>&nbsp;</p>
        <p>&nbsp;</p>
