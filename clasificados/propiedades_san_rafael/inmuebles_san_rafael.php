...
$query_Recordset2 = "SELECT * FROM inmuebles GROUP BY fecha ORDER BY fecha ASC";
...
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset3 = "SELECT * FROM inmuebles GROUP BY fecha ORDER BY fecha ASC";
...
$query_Recordset1 = "SELECT * FROM inmuebles WHERE fecha BETWEEN '$fecha1' AND '$fecha2' ORDER BY fecha DESC" ; }
else { if (isset($_GET['rubro2'])) { 
$query_Recordset1 = "SELECT * FROM inmuebles WHERE rubro LIKE '%$rubro2%'  " ; }
else {
$query_Recordset1 = "SELECT * FROM inmuebles ORDER BY fecha ASC"; } }
...
<title>Propiedades e Inmuebles en San Rafael || SRL Clasificados || San Rafael ||</title>
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td colspan="3" class="titulos_seccion">Inmuebles </td>
        </tr>
        <tr>
          <td colspan="3">&nbsp;</td>
        </tr>
        <tr>
          <td width="64%" bgcolor="#C2D1E7" class="contenedor_buscador"><form id="form1" name="form1" method="get" action="inmuebles_san_rafael.php">
...
<br/>
        ...
        <tr>
          <td height="69" bgcolor="#FFFFFF"><form action="inmuebles_san_rafael.php" method="get" name="form2" class="texto_opciones" id="form2">
        ...
        <tr>
		  ...
		  <?php do { ?>
		    <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="15%"><?php if ($row_Recordset1['imagen'] != NULL) {?>
                  <img src="../fotos-clasificados/propiedades/thumbs/<?php echo $row_Recordset1['articulos_id']; ?>.jpg" width="70" height="70" hspace="2" vspace="2" />
                  <?php } else {?>
                  <img src="../fotos-clasificados/sin_imagen.jpg" width="70" height="70" hspace="2" vspace="2" />
                  <?php }  ?></td>
                <td width="85%" valign="top"><div class="contenedor_anuncios">
                  <div><span class="fecha_anuncio"><?php echo $row_Recordset1['fecha']; ?></span><span class="texto_opciones"> -</span> <span class="titulo_anuncios"><?php echo $row_Recordset1['nombre']; ?></span> - <span class="texto_opciones">Tipo : <?php echo $row_Recordset1['tipo_inmueble']; ?></span>- <span class="texto_opciones">Operacion : <?php echo $row_Recordset1['operacion']; ?></span></div>
                  <div class="texto_anuncio"><?php echo ucfirst($row_Recordset1['anuncio']); ?></div>
                  <div class="rubros">
                    <div align="right"><a href="propiedades_detalles.php?inmuebles_id=<?php echo $row_Recordset1['inmuebles_id']; ?>">+ ampliar &gt;&gt; </a></div>
                  </div>
                </div></td>
              </tr>
            </table>
