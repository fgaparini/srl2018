...
mysql_select_db($database_clasificados, $clasificados);
$query_usuario_pregunta = sprintf("SELECT * FROM preguntas, usuarios WHERE usuarios.usuario=%s AND  preguntas.usuario_pregunta =usuarios.usuario   ", GetSQLValueString($user_usuario_pregunta, "text"));
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="texto_link_chico"><a href="index.php">mi cuenta</a> &gt;&gt; <a href="preguntas.php">pregusntas</a> &gt;&gt;Tus  preguntas</td>
        </tr>
        <tr>
          <td width="100%" class="titulos_seccion">MI CUENTA &gt;&gt; <span class="RUBRO_TITULOS">Tus Preguntas </span></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
      ...
      <?php do { ?>
        <table width="547" border="0" cellpadding="0" cellspacing="0" bordercolor="#ECE9D8" bgcolor="#FFFFFF" class="recuadro_1">

          <tr>
            <td width="548" height="20px" align="left" valign="middle" bgcolor="#000099" class="texto_blanco"><p class="texto_blanco">Preguntaste por</p></td>
          </tr>
          <tr>
            <td height="25" align="left" valign="top" bgcolor="#E8E8FF" class="texto_negro"><div align="left">
...
?>
          ...
          <tr bgcolor="#F7F7F7">
            <td height="24" align="left" valign="top" bgcolor="#E8E8FF" class="texto_negro"><strong>Anuncio:</strong> <?php echo $row_clasificado_pregunta['anuncio']; ?></td>
          </tr>
          <tr bgcolor="#F7F7F7">
            <td align="left" bgcolor="#E8E8FF" class="texto_negro"><div align="left"><strong>Fecha: </strong><strong class="fecha_anuncio"><?php echo $row_clasificado_pregunta['fecha']; ?></strong></div>
                <div align="left"></div></td>
          </tr>

          <tr bgcolor="#F7F7F7">
            <td height="20px" valign="middle" bgcolor="#006600" class="texto_blanco"><p>Tu Pregunta </p></td>
          </tr>
          <tr bgcolor="#F7F7F7">
            <td height="26" bgcolor="#DFFFDF" class="texto_negro"><?php echo $row_usuario_pregunta['pregunta']; ?></td>
          </tr>
          <tr>
            <td bgcolor="#DFFFDF"><strong>Pregunt&oacute;: <span class="sos_nuevo"><?php echo $row_usuario_pregunta['usuario_pregunta']; ?> </span></strong></td>
          </tr>
          <tr bgcolor="#F7F7F7">
            <?php $tipo_clasi = $row_usuario_pregunta['tipo_clasi'] ;
			$clasi_id=$row_usuario_pregunta['clasificado_id'];
...
$totalRows_clasificado_pregunta = mysql_num_rows($clasificado_pregunta);
?>
            <td align="left" bgcolor="#DFFFDF" class="texto_negro"><div align="left"><strong>Fecha: </strong><strong class="fecha_anuncio"><?php echo $row_usuario_pregunta['fecha_pregunta']; ?></strong></div>
                <div align="left"></div></td>
          </tr>

          <tr>
            <td height="22" valign="middle" bgcolor="#666666" class="texto_blanco"><p>La Respuesta:</p></td>
          </tr>
          <tr>
            <td bgcolor="#FFFFFF" ><span >
              <?php if ($row_usuario_pregunta['respuesta'] != NULL ) { ?>
              </span><?php echo $row_usuario_pregunta['respuesta']; ?><span class="linea_detalles">
                <?php } else { echo 'no se formulo la respuesta todavia...';} ?>
              </span></td>
          </tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><div align="center"><span class="texto_anuncio"> Registros <?php echo ($startRow_usuario_pregunta + 1) ?> a <?php echo min($startRow_usuario_pregunta + $maxRows_usuario_pregunta, $totalRows_usuario_pregunta) ?> de <?php echo $totalRows_usuario_pregunta ?> </span></div></td>
          </tr>
          <tr>
            <td align="center"><table border="0">
              <tr>
                <td class="texto_link_chico"><?php if ($pageNum_usuario_pregunta > 0) { // Show if not first page ?>
                ...
                <td class="texto_link_chico"><?php if ($pageNum_usuario_pregunta < $totalPages_usuario_pregunta) { // Show if not last page ?>
