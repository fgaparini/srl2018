...
$id_art = $categoria."_id";
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset2 = "SELECT * FROM $categoria ORDER BY  $id_art DESC";
...
if ((isset($_POST["Submit"])) && ($_POST["categoria"] == "servicio"))  {
  $insertSQL = sprintf("INSERT INTO $categoria (rubro, subrubro, nombre, anuncio, fecha, id_usuario, precio) VALUES (%s, %s, %s, %s, %s, %s,%s)",
 ...
 elseif ($_POST["categoria"] == "empleos") {
$insertSQL = sprintf("INSERT INTO $categoria (rubro, nombre, anuncio, fecha, id_usuario) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['rubro'], "text"),
                       GetSQLValueString($_POST['titulo'], "text"),
                       GetSQLValueString($_POST['anuncio'], "text"),
                       GetSQLValueString($_POST['fecha'], "text"),
  ...
  $insertSQL = sprintf("INSERT INTO $categoria (rubro, nombre, anuncio, fecha, id_usuario, precio) VALUES (%s, %s, %s, %s, %s,%s)",
                       GetSQLValueString($_POST['rubro'], "text"),
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="23" bgcolor="#FF0000" class="menu_superior">Agregar Imagen a anuncio N&ordm; <?php echo $row_Recordset2['$categoria_id']; ?></td>
        </tr>
        <tr>
          <td><form action="insertar_anuncio2.php" method="post" enctype="multipart/form-data" name="frm" id="frm">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="33%" height="40" bgcolor="#FFECEC" class="textoguias"><div align="right">buscar Archivo</div></td>
                <td width="6%" height="40" bgcolor="#FFECEC">&nbsp;</td>
                <td width="61%" height="40" bgcolor="#FFECEC" class="texto_opciones"><label>
              ...
              <tr>
                <td bgcolor="#FFECEC"><?php echo $row_Recordset2[$categoria.'_id']; ?>&nbsp;</td>
                <td bgcolor="#FFECEC">&nbsp;</td>
                <td bgcolor="#FFECEC"><label>
                  <input name="Submit" type="submit" class="sos_nuevo" value="Subir Imagen" />
                  <input name="usuario_id" type="hidden" id="usuario_id" value="<?php echo $row_Recordset1['id_usuario']; ?>" />
                  <input name="id" type="hidden" id="id" value="<?php echo $row_Recordset2[$categoria.'_id']; ?>" />
                  <input name="categoria" type="hidden" id="auto_id2" value="<?php echo $categoria; ?>" />
                </label></td>
              </tr>
              <tr>
                <td bgcolor="#FFECEC"><span class="textoguias"><?php echo $id_art; ?></span></td>
                <td bgcolor="#FFECEC">&nbsp;</td>
                <td bgcolor="#FFECEC">&nbsp;</td>
              </tr>
              <tr>
                <td><span class="titulos_Noticias"><?php echo $categoria; ?></span></td>
                <td><span class="titulos_seccion"><?php echo $row_Recordset2['nombre']; ?></span></td>
              </tr>
              <tr>
                <td colspan="3"><div align="center" class="rubros_articulos_seleccionado"><a href="escribir_clasificado.php">Finalizar Anuncio &gt;&gt;</a></div></td>
              </tr>
            </table>
          </form></td>
        </tr>
