...
if (isset($_SERVER['QUERY_STRING'])) {
 ...
 if ($base_datos==articulos) {
$precio = $_POST['precio']; }
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO anuncios_guardados (anuncio_id, anuncio_nombre, anuncio_rubro, anuncio_texto, anuncio_fecha, usuario_id, categoria, precio) VALUES (%s, %s, %s, %s, %s, %s, %s, '$precio')",
...
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset1 = "SELECT * FROM anuncios_guardados";
  ...
  <tr>
    <td width="350"><form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
      <table width="350" border="0" align="left" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="80" bgcolor="#FFFFCC" class="chamullo_guias"><div align="right"><strong>Rubro</strong></div></td>
          <td valign="middle" bgcolor="#FFFFCC" class="texto_opciones">
            <div align="left">
        ...
        <?php if ($base_datos==articulos) {?> <tr>
