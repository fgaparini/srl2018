...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO anuncios_guardados (anuncio_id, anuncio_nombre, anuncio_rubro, anuncio_texto, anuncio_fecha, usuario_id, categoria, subrubro) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "guardar_confrimacion";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <tr>
    <td width="350"><form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
      <table width="350" border="0" align="left" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="80" bgcolor="#FFFFCC" class="chamullo_guias"><div align="right"><strong>Categoria</strong></div></td>
          <td valign="middle" bgcolor="#FFFFCC" class="texto_opciones">
            <div align="left">
              <input name="categoria" type="text" id="categoria" value="<?php echo $base_datos ; ?>" />
              </div></td>
        </tr>
        <tr>
          ...
          <td valign="middle" bgcolor="#FFFFCC" class="texto_opciones"><div align="left">
              <input name="rubro" type="text" id="rubro" value="<?php echo $row_Recordset2['rubro']; ?>" />
          </div></td>
        </tr>
        <tr>
          <td width="80" bgcolor="#FFFFCC" class="chamullo_guias"><div align="right"><strong>Subrubro</strong></div></td>
          <td valign="middle" bgcolor="#FFFFCC" class="texto_opciones">
            <div align="left">
              <input name="subrubro" type="text" id="subrubro" value="<?php echo $row_Recordset2['subrubro']; ?>" />
              </div></td>
        </tr>
        <tr>
