      ...
      <table width="350" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td valign="middle" bgcolor="#FFFFCC" class="texto_opciones">
            <div align="left"><?php echo $row_Recordset2['tipo']; ?> </div></td></tr>
        <tr>
          <td bgcolor="#FFFFCC" class="chamullo_guias"><div align="right"><strong>Marca: </strong></div></td>
          <td valign="middle" bgcolor="#FFFFCC" class="texto_opciones"><div align="left"><?php echo $row_Recordset2['marca']; ?> </div></td>
        </tr>
        <tr>
          <td bgcolor="#FFFFCC" class="chamullo_guias"><div align="right"><strong>Modelo: </strong></div></td>
          <td valign="middle" bgcolor="#FFFFCC" class="texto_opciones">
                <div align="left"><?php echo $row_Recordset2['modelo']; ?> </div></td></tr>
        <tr>
        ...
        <tr>
          <td colspan="2" bgcolor="#FFFFCC"><div align="center">
            ...
            <input name="categoria" type="hidden" id="categoria" value="<?php echo $row_Recordset2['tipo']; ?>" />
            <input name="rubro" type="hidden" id="rubro" value=" <?php echo $row_Recordset2['marca']; ?>" />
            <input name="subrubro" type="hidden" id="subrubro" value=" <?php echo $row_Recordset2['modelo']; ?>" />
