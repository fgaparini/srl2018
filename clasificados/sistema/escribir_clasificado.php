...
function activaPrecio(){
with (document.frm){
precio.disabled = (categoria[categoria.selectedIndex].value == "empleos");
if (!precio.disabled)
precio.focus();
}
}
    ...
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <span class="RUBRO_TITULOS">Publicacion de Anuncios </span></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td><form id="frm" name="frm" method="post" action="subir_foto_anuncio.php">
            <table width="548" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="219" align="left" class="textoguias"><div align="right">Seleccionar Categoria: </div></td>
                <td width="4">&nbsp;</td>
                <td width="325" class="texto_opciones"><select name="categoria" id="categoria" onchange="activaOtro();cambia(document.frm.rubro); activaPrecio() ">
                  <option value="empleos">Empleos</option>
                  <option value="profesionales" selected="selected">Guia Profesionales</option>
              ...
              <tr>
                <td width="219px" height="39" align="left" class="textoguias"><div align="right">Seleccionar Rubro: </div></td>
                <td width="4">&nbsp;</td>
                <td width="325px" class="texto_opciones"><select name="rubro" id="rubro" onchange="cambia2(document.frm.otro)">
              ...
              <tr>
                <td width="219" align="left" class="textoguias"><div align="right">Seleccionar Subrubro: </div></td>
                <td width="4">&nbsp;</td>
                <td width="325" class="texto_opciones"><select name="otro" size="1" disabled="disabled" id="otro">
              ...
              <tr>
                <td width="219" height="40" align="left" class="textoguias"><div align="right">Titulo:</div></td>
                <td width="4" height="40">&nbsp;</td>
                <td width="325" height="40" class="texto_opciones"><label>
                  <input name="titulo" type="text" id="titulo" size="30" />
                </label></td>
              </tr>
              <tr>
                <td width="219" height="40" align="left" class="textoguias"><div align="right">Anuncio:</div></td>
                <td width="4" height="40">&nbsp;</td>
                <td width="325" height="40" class="texto_opciones"><textarea name="anuncio" cols="38" rows="8" id="anuncio"></textarea></td>
              </tr>
              <tr>
                <td width="219" height="40" align="left" class="textoguias"><div align="right">Precio:</div></td>
                <td width="4" height="40">&nbsp;</td>
                <td width="325" height="40" class="texto_opciones"><label>
                  <input name="precio" type="text" id="precio" disabled="disabled" size="30" />
                </label></td>
              </tr>
              <tr>
                <td width="219" align="left"><div align="right"></div></td>
                <td width="4">&nbsp;</td>
                <td width="325">&nbsp;</td>
              </tr>
              <tr align="left">
