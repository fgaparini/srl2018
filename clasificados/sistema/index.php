  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="titulos_seccion">MI CUENTA </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td width="39%"><table width="100%" height="60" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="130"><div align="left"><a href="publique_anuncio.php"><img src="../iconos/escribir-anuncio.jpg" alt="Escribir Anuncio" width="128" height="128" border="0" /></a></div></td>
              <td width="130"><div align="center"><a href="mis_anuncios.php"><img src="../iconos/Avisos-publicados.jpg" alt="Mis anuncios" width="128" height="128" border="0" /></a></div></td>
              <td width="130"><div align="center"><a href="mis_datos.php"><img src="../iconos/mis-datos.png" alt="Modificar Datos" width="128" height="128" border="0" /></a></div></td>
              <td width="130"><div align="center"><a href="anuncios_guadados.php"><img src="../iconos/favoritos.jpg" alt="Avisos Favoritos" width="128" height="128" border="0" /></a></div>                
              <div align="center"></div></td>
              </tr>
            <tr>
              <td width="130" class="texto_panel"><div align="center"><a href="publique_anuncio.php">Escribir   Anuncio </a></div></td>
              <td width="130" class="texto_panel"><div align="center"><a href="mis_anuncios.php">Mis Anuncios </a></div></td>
              <td width="130" class="texto_panel"><div align="center"><a href="mis_datos.php">Mis Datos </a></div></td>
              <td width="130" class="texto_panel"><div align="center"><a href="anuncios_guadados.php">Anuncios Guardados </a></div>                
              <div align="center"></div></td>
              </tr>
            <tr>
              <td class="titulo_anuncios">&nbsp;</td>
              <td class="titulo_anuncios">&nbsp;</td>
              <td class="titulo_anuncios">&nbsp;</td>
              <td class="titulo_anuncios">&nbsp;</td>
            </tr>
            <tr>
              <td class="titulo_anuncios"><div align="center"><a href="agregar_curriculum.php"><img src="../iconos/curriculum.png" alt="Envianos Tu Curriculum" width="128" height="128" border="0" /></a></div></td>
              <td class="titulo_anuncios"><div align="center"><a href="ayuda_sistema.php"><img src="../iconos/preguntas.jpg" alt="Ayuda para usar panel de Control MI CUENTA" width="128" height="128" border="0" /></a></div></td>
              <td class="titulo_anuncios"><div align="center"><a href="ayuda_sistema.php"><img src="../iconos/ayuda.jpg" alt="Ayuda para usar panel de Control MI CUENTA" width="128" height="128" border="0" /></a></div></td>
              <td class="titulo_anuncios"><div align="center"><a href="<?php echo $logoutAction ?>"><img src="../iconos/salir.png" alt="Salir" width="128" height="128" border="0" /></a></div></td>
            </tr>
            <tr>
              <td class="texto_panel"><div align="center"><a href="agregar_curriculum.php">Redacta Tu Curriculum </a></div></td>
              <td class="texto_panel"><div align="center"><a href="pregunta_clasificados.php">Preguntas</a></div></td>
              <td class="texto_panel"><div align="center">
                <div align="center"><a href="ayuda_sistema.php">Ayuda</a></div>
              </div></td>
              <td class="texto_panel"><div align="center"><a href="<?php echo $logoutAction ?>">Salir</a></div></td>
            </tr>
          </table></td>
        </tr>
        <tr>
