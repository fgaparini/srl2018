...
$si = "si";
$autos_id = $_POST['auto_id'];
$usuario_id = $_POST['usuario_id'];
if (isset($_POST['Submit'])) { 

    if(is_uploaded_file($_FILES['imagen']['tmp_name'])) {
$path = "../fotos-clasificados/automotores/";
$path2 = "../fotos-clasificados/automotores/thumbs/";
//redimensionar-------------
...
$sql1 = " UPDATE autos SET imagen = 'si' WHERE autos_id = $autos_id "; 
mysql_query($sql1, $clasificados) or die ("No se pudo insertar los datos en la base de datos. $imagen"); 
} 
else {
    ...
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <span class="RUBRO_TITULOS">Confirmacion Publicacion Autos </span></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
        <tr></tr>
        <tr>
          <td class="texto_opciones"><span class="texto_negro"><?php echo $imagen ;?> en</span><span class="sos_nuevo"> SRL CLASIFICADOS</span></td>
        </tr>
        <tr>
