...
if ((isset($_POST["Submit"])) && ($_POST["categoria"] == "servicio"))  {
  $insertSQL = sprintf("INSERT INTO $categoria (rubro, subrubro, nombre, anuncio, fecha, id_usuario) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="texto_opciones">Su anuncio clasificado <span class="texto_panel"><?php echo $_POST[titulo] ; ?></span> se publico correctamente en la categoria <span class="texto_panel"> <?php echo $categoria ; ?></span>, y rubro  <span class="texto_panel"><?php echo $_POST[rubro] ; ?></span></td>
        </tr>
        <tr>
