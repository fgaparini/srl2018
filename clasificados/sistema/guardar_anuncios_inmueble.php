      ...
      <table width="350" border="0" align="left" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td valign="middle" bgcolor="#FFFFCC" class="texto_opciones">
            <div align="left">
              <input name="categoria" type="text" id="categoria" value="<?php echo $row_Recordset2['tipo_inmueble']; ?>" />
              </div></td>
        </tr>
        <tr>
          ...
          <td valign="middle" bgcolor="#FFFFCC" class="texto_opciones"><div align="left">
              <input name="rubro" type="text" id="rubro" value="<?php echo $row_Recordset2['operacion']; ?>" />
          </div></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="2" bgcolor="#FFFFCC"><div align="center">
            <input name="subrubro" type="hidden" id="subrubro" value="-" />
            <input name="base" type="hidden" id="base" value="inmueble" />
