...
if (isset($_POST['Submit'] )) {
  $insertSQL = sprintf("INSERT INTO autos (nombre, tipo, anuncio, usuario_id, fecha, marca, modelo, precio) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
...
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset2 = "SELECT * FROM autos ORDER BY autos_id DESC";
...
<title>Clasificados San Rafael Mi Cuenta:: publicacion autos :: subir imagen</title>
    ...
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <span class="RUBRO_TITULOS">Imagen de Anuncios  Autos </span></td>
        </tr>
        <tr>
          <td class="texto_opciones"><div align="left"><img src="../imagenes/boton2" width="50" height="50" hspace="5" align="left" />Su anuncio clasificado de Autos se publico correctamente en <span class="sos_nuevo">SRL CLASIFICADOS. </span><br />
          En este paso debes agregar una foto en caso que lo desee. lo contrario De haz clic en<strong> finalizar anuncio</strong>.</div></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td height="23" bgcolor="#FF0000" class="menu_superior">Agregar Imagen a anuncio N&ordm; <?php echo $row_Recordset2['autos_id']; ?></td>
        </tr>
        <tr>
          <td><form action="confirmacion_auto.php" method="POST" enctype="multipart/form-data" name="frm" id="frm">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
              ...
              <tr>
                ...
                <td bgcolor="#FFECEC"><label>
                  ...
                  <input name="auto_id" type="hidden" id="auto_id" value="<?php echo $row_Recordset2['autos_id']; ?>" />
                </label></td>
              </tr>
              <tr>
                <td bgcolor="#FFECEC">&nbsp;</td>
