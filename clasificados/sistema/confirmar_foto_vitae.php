...
$path = "../fotos-clasificados/curriculum/";
$path2 = "../fotos-clasificados/curriculum/thumbs/";
//redimensionar-------------
...
$sql1 = " UPDATE curriculum SET foto = 'si' WHERE id_curriculum = $articulos_id "; 
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><form method="POST" enctype="multipart/form-data" name="form1" id="form1" action="confirmar_foto_viate">
           <?php echo $imagen ; ?>
          </form>
