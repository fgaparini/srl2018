...
$si = "si";
$articulos_id = $_POST['id'];
$usuario_id = $_POST['usuario_id'];
$id_art = $categoria."_id";
if (isset($_POST['Submit'])) { 

    if(is_uploaded_file($_FILES['imagen']['tmp_name'])) {
$path = "../fotos-clasificados/$categoria/";
$path2 = "../fotos-clasificados/$categoria/thumbs/";
//redimensionar-------------
...
$thumb2 = imagecreatetruecolor($new_width2,$new_height2);
imagecopyresized($thumb,$image,0,0,0,0,$new_width,$new_height,$width,$height);
imagecopyresized($thumb2,$image,0,0,0,0,$new_width2,$new_height2,$width,$height);
ImageJPEG($thumb, $path. $nombre.".jpg");
ImageJPEG($thumb2, $path2. $nombre.".jpg");
  
imagedestroy($image);
//agregar a base

$imagen = "La Imagen se agrego correctamente";
$sql1 = " UPDATE $categoria SET imagen = '$si' WHERE $id_art = $articulos_id "; 
mysql_query($sql1, $clasificados) or die ("No se pudo insertar los datos en la base de datos."); 
} 
else {
$imagen="Imagen  no subio  o se produzco un error al subir";
}
}
...
<title>Clasificados San Rafael Mi Cuenta :: Comfirmacion Imagen</title>
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="texto_opciones">Su anuncio clasificado se publico correctamente.</td>
        </tr>
        <tr>
      ...
      <p><span class="RUBRO_TITULOS"><?php echo $categoria ?></span></p>
      <p><span class="textoguias"><?php echo $articulos_id ?></span></p>
      <p>&nbsp;</p>
