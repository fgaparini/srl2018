  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td colspan="3" class="titulos_seccion">MI CUENTA &gt;&gt; <br/><span class="RUBRO_TITULOS">Publicacion de Anuncios </span></td>
        </tr>
        <tr>
          <td colspan="3">&nbsp;</td>
        </tr>
        <tr>
          <td colspan="3" class="texto_opciones">Elija una un rubro a publicar su anuncio. </td>
        </tr>
        <tr>
          <td colspan="3">&nbsp;</td>
        </tr>
        <tr>
          <td height="30" class="rubros_articulos"><div align="center"><a href="escribir_clasificado_inmuebles.php">Inmuebles</a></div></td>
          <td height="30" class="rubros_articulos"><div align="center"><a href="escribir_clasificado_auto.php">Automotores</a></div></td>
          <td height="30" class="rubros_articulos"><div align="center"><a href="escribir_clasificado.php">Articulos </a></div></td>
        </tr>
        <tr>
          <td height="30" class="rubros_articulos"><div align="center"><a href="escribir_clasificado.php">Empleos</a></div></td>
          <td height="30" class="rubros_articulos"><div align="center"><a href="escribir_clasificado.php">Educacionales</a></div></td>
          <td height="30" class="rubros_articulos"><div align="center"><a href="escribir_clasificado.php">Profesionales</a></div></td>
        </tr>
        <tr>
          <td height="30" class="rubros_articulos"><div align="center"><a href="escribir_clasificado.php">Legales</a></div></td>
          <td height="30" class="rubros_articulos"><div align="center"><a href="escribir_clasificado.php">Servicios</a></div></td>
          <td height="30" class="rubros_articulos">&nbsp;</td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
