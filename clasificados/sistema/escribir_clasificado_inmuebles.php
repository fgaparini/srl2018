    ...
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <span class="RUBRO_TITULOS">Publicaci&oacute;n de Anuncios Inmuebles </span></td>
        </tr>
        <tr>
          <td><span class="texto_opciones">Publique un anuncio clasificado de Inmuebles como casas, lotes, campos, fincas, locales, etc </span></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td><form id="frm" name="frm" method="POST" action="confirmar_inmueble.php">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="33%" class="textoguias"><div align="right">Seleccionar Tipo: </div></td>
                <td width="6%">&nbsp;</td>
                <td width="61%" class="texto_opciones"><select name="tipo" class="texto_opciones" id="tipo">
                  <option value="casas" selected="selected">casas</option>
              ...
              <tr>
                <td height="39" class="textoguias"><div align="right">Seleccionar Operacion: </div></td>
                <td>&nbsp;</td>
                <td class="texto_opciones"><select name="operacion" class="texto_opciones" id="operacion" onchange="cambia2(document.frm.otro)">
