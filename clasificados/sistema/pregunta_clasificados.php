...
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset1 = "SELECT * FROM preguntas, usuarios WHERE preguntas.usuario_art_id=usuarios.id_usuario ORDER BY preguntas.pregunta_id ASC";
...
if (isset($SESSION['MM_Username'])) {
  $user_usuario_pregunta = $SESSION['MM_Username'];
}
mysql_select_db($database_clasificados, $clasificados);
$query_usuario_pregunta = sprintf("SELECT * FROM usuarios, preguntas WHERE usuarios.usuario=%s AND usuarios.id_usuario =preguntas.usuario_pregunta", GetSQLValueString($user_usuario_pregunta, "double"));
$usuario_pregunta = mysql_query($query_usuario_pregunta, $clasificados) or die(mysql_error());
$row_usuario_pregunta = mysql_fetch_assoc($usuario_pregunta);
$totalRows_usuario_pregunta = mysql_num_rows($usuario_pregunta);
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="2" class="texto_link_chico"><a href="index.php">&lt;&lt; volver</a></td>
        </tr>
        <tr>
          <td colspan="2" class="titulos_seccion">MI CUENTA &gt;&gt; <span class="RUBRO_TITULOS">Preguntas </span></td>
        </tr>
        <tr>
          <td colspan="2" class="texto_opciones">En esta seccion encontraras las preguntas  realizadas a tus clasificados y las respuestas, como las preguntas realizadas por vos a anuncios clasificados de otros usuarios y las respuestas de estos a ellas.<br />
Elige la opcion que deseas visualizar</td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="54%" class="rubros_articulos_seleccionado"><a href="pregunta_a_tus_clasificados.php">Preguntas a tus Clasificados &gt;&gt;</a></td>
          <td width="46%" class="rubros_articulos_seleccionado"><a href="preguntas.php">Tus Preguntas &gt;&gt;</a></td>
        </tr>
        <tr>
          <td colspan="2" class="texto_negro">&nbsp;</td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
        </tr>
