...
if (isset($_GET['autos_id'])) {
  $colname_Recordset1 = $_GET['autos_id'];
}
mysql_select_db($database_clasificados, $clasificados);
$query_Recordset1 = sprintf("SELECT * FROM autos WHERE autos_id = %s", GetSQLValueString($colname_Recordset1, "int"));
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="rubros"><a href="../index.php">Inicio&gt;&gt;</a> <a href="autos_san_rafael.php">Autos&gt;&gt;</a></td>
        </tr>
        <tr>
        ...
        <tr>
          <td bgcolor="#FFFFFF"><div align="right">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="linea_detalles">
              <tr>
                <td width="3%">&nbsp;</td>
                <td width="57%" valign="middle"><div align="right"><a href="#" onclick="abrirpopup('../sistema/guardar_anuncios_auto.php?anuncio_id=<?php echo $row_Recordset1['autos_id']; ?>',450,450)"><img src="../iconos/agrega_favoritos.jpg" alt="Agregar a favoritos" width="25" height="25" border="0" title="Agregue Anuncio a Anuncios Guardados" /> <span class="texto_link_chico">Guardar para seguimiento</span></a></div></td>
                <td width="4%" valign="middle">&nbsp;</td>
                <td width="14%" valign="middle"><div align="left"><span class="texto_link_chico"><a href="#" onclick="abrirpopup('../sistema/guardar_anuncio.php?anuncio_id=<?php echo $row_Recordset1['articulos_id']; ?>&amp;&amp;base_datos=articulos',450,450)"> </a></span><a  href="#" onclick="abrirpopup('../sistema/imprimir_anuncio_auto.php?anuncio_id=<?php echo $row_Recordset1['autos_id']; ?>',450,500)"><img src="../iconos/imprimir.png" alt="Imprimir anuncio" width="25" height="25" border="0"  title="Imprima Anuncio" /><span class="texto_link_chico">imprimir</span></a></div></td>
                <td width="2%" valign="middle">&nbsp;</td>
                <td width="20%" valign="middle"><div align="left"><a  href="#" onclick="abrirpopup('../sistema/enviarxemail_auto.php?anuncio_id=<?php echo $row_Recordset1['autos_id']; ?>',450,600)"><img src="../iconos/email-enviar.png" alt="Enviar por Mail" width="30" height="30" border="0" /><span class="texto_link_chico">enviar a un amigo</span></a></div></td>
              </tr>
            </table>
          </div></td>
        </tr>
          ...
          <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="54%" valign="top" class="contenedor_opciones"><table width="97%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td width="106" class="texto_negro"><strong>Tipo:</strong></td>
                  <td class="texto_opciones"><span class="texto_opciones"><?php echo $row_Recordset1['tipo']; ?></span></td>
                </tr>
                <tr>
                  <td width="106" class="texto_negro"><strong>Marca:</strong></td>
                  <td class="texto_opciones"><span class="texto_opciones"><?php echo $row_Recordset1['marca']; ?></span></td>
                </tr>
                <tr>
                  <td width="106" class="texto_negro"><strong>Modelo:</strong></td>
                  <td class="texto_opciones"><span class="texto_opciones"><?php echo $row_Recordset1['modelo']; ?></span></td>
                </tr>
                <tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><div align="center">
              <p class="texto_anuncio"><a href="#" class="texto_link_chico" onclick="abrirpopup('../sistema/hacer_pregunta.php?clasi_id=<?php echo $row_Recordset1['autos_id']; ?>&&tipo_clasi=autos&&usuario_art_id=<?php echo $row_Recordset1['usuario_id']; ?>',600,450)"><strong>Hacer Pregunta</strong> (solo usuarios registrados) &gt;&gt;</a></p>
          </div></td>
        </tr>
        <tr>
    ...
    <td valign="top" class="bordes_lateral_guias"><div class="guias_contenedor">
      ...
      <div >
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="left" valign="middle"><a href="autos_san_rafael.php"><img src="../imagenes/automotores.jpg" alt="automotores en san rafael" width="40" height="40" border="0" /></a></td>
            <td align="left" valign="middle" class="rubros"><a href="autos_san_rafael.php">Automotores</a> </td>
