...
$fecha1 = $_GET['fecha1'] ;
$fecha2 = $_GET['fecha2'] ;
$paginar ='fecha1=$fecha1&&fecha2=$fecha2';

if (isset($_GET['fecha1'])) { 
$query_Recordset1 = "SELECT * FROM autos WHERE fecha BETWEEN '$fecha1' AND '$fecha2' ORDER BY autos_id DESC" ; }
else { if (isset($_GET['rubro2'])) { 
$query_Recordset1 = "SELECT * FROM autos WHERE tipo LIKE '%$rubro2%' ORDER BY autos_id DESC " ; }
else {
$query_Recordset1 = "SELECT * FROM autos ORDER BY autos_id DESC"; } }
...
<title>Autos Motos en San Rafael || Clasificados SRL || San Rafael ||</title>

<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<meta name="description" lang="es" content="Clasificados SRL :: Clasificados en San Rafael :: Autos  en San Rafael, Motos en San Rafael, Nauticos en San Rafael, Automotores en San Rafael, venta permuta compra anuncios CLASIFICADOS de SAN RAFAEL.. clasificados.sanrafaellate.com.ar "/>
<meta name="keywords" lang="es" content="Clasificados, San Rafael, Mendoza, Autos, Empleos, Inmubeles, Propiedades, articulos, educacionales, judiciales, legales, profesionales " />
  ...
  <tr>
    <td width="550" valign="top"><!-- InstanceBeginEditable name="centro" -->
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td colspan="3" class="titulos_seccion">Automotores en San Rafael </td>
        </tr>
        <tr>
          <td colspan="3">&nbsp;</td>
        </tr>
        <tr>
          <td width="64%" bgcolor="#C2D1E7" class="contenedor_buscador"><form id="form1" name="form1" method="get" action="autos_san_rafael.php">
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','190','height','190','hspace','2','vspace','2','title','San Rafael Late','src','../publicidad/publi_next_buscador','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','../publicidad/publi_next_buscador' ); //end AC code
        ...
        <tr>
          <td height="69" bgcolor="#FFFFFF"><form action="autos_san_rafael.php" method="get" name="form2" class="texto_opciones" id="form2">
            <div align="left"><strong>&nbsp; Buscar por tipo &gt;&gt;</strong>
              <select name="rubro2" class="texto_anuncio" id="rubro2">
                <option value="auto">auto</option>
                <option value="caminetas">camineta</option>
               ...
               <input name="Submit3" type="submit" class="texto_anuncio" value="buscar" />
            </div>
          </form></td>
        </tr>
        <tr>
		    ...
		    <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="80%" valign="top"><div class="contenedor_anuncios">
                  <div><span class="fecha_anuncio"><?php echo $row_Recordset1['fecha']; ?></span><span class="texto_opciones"> -</span> <span class="titulo_anuncios"><?php echo $row_Recordset1['nombre']; ?></span> - <span class="texto_opciones"><strong>Tipo </strong>:<?php echo $row_Recordset1['tipo']; ?> </span>- <span class="texto_opciones"><strong>Marca</strong> : <?php echo $row_Recordset1['marca']; ?></span> - <span class="texto_opciones"><strong>Modelo</strong> : <?php echo $row_Recordset1['modelo']; ?></span><span class="texto_opciones"><?php echo $row_Recordset1['tipo']; ?></span></div>
                  <div class="texto_anuncio"><?php echo ucfirst($row_Recordset1['anuncio']); ?></div>
                  <div class="rubros">
                    <div align="right"><a href="autos_detalles.php?autos_id=<?php echo $row_Recordset1['autos_id']; ?>">+ ampliar &gt;&gt; </a></div>
                  </div>
                </div></td>
              </tr>
            </table>
