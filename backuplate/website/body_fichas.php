 ...
 <div id="contenedorInt">
  <div id="cont_int">
    <div id="fichasD" itemscope itemtype="http://schema.org/LodgingBusiness" >
      ...
      <div class="tituloSocial" align="left">
        <!-- TITULO  -->
        <div ><h1 align="left" itemprop="name"><?php echo $row_Al['TipoAlojamiento']; ?> <?php echo $row_Al['Nombre']; ?></h1></div>
  ...
  <div id="ficha_info">
    <div id="ficha-tabs">
      ...
      <div id="ficha-tabs2">
        ...
        <div id="tabs-12" itemprop="description"> <div id="descripcion" align="left"> <?php echo $row_Al['Descripcion'] ?> </div></div>
      ...
      <div id="ficha_datos">
        <div id="datos_alojar" class="border-Corner borde-gris " align="left">
          ...
          <p ><img src="<?php echo base_url() . "iconos/phone.png"; ?>" alt=""> <b>Teleono: </b><span itemprop="telephone" ><?php echo $row_Al['Telefono']; ?></span></p>
          <?php if($row_Al['WebSite']!="") { ?> <p><img src="<?php echo base_url() . "iconos/url2.png"; ?>" alt=""> <b>Website:</b> <a href="<?php echo base_url()."contador/alojar/web/" .$row_Al['ID_Alojamiento']."/?dir=".$row_Al['WebSite']; ?>" target="_blank" title="Vistie el Web del Alojamiento"><?php echo  idn_to_utf8($row_Al['WebSite']); ?></a></p><?php } ?>
          <!-- SOCIAL ALOJAMIENTOS -->
          <div id="socialA">
            <?php
            //FACEBOOK
     ...
     <?php
      $bs=RAND(1,2) ;?>
        <div style=";" align="left" id="<?php echo "bookingcom".$bs ?>">
          <h2>Reserva Online </h2>
            ...
            <input type="text" name="frombook" id="frombook"></div>
            <div class="fechas" align="left">
            <label for="">Salida</label>
            <input type="text" name="tobook" id="tobook"></div><br>
            <div>  
              <?php if ($bs==1): ?>
           ...
           <?php endif ?>
        <div class="border-Corner borde-gris" align="left" id="consultaF">  <h2>Enviar una Consulta</h2>  <form id="fromA" method="post"> <div id="form"  align="left" >
      ...
      <?php if($row_Al['WebSite']!="") { ?> <div class="border-Corner borde-gris" align="center">
