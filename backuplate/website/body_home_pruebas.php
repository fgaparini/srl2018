                        ...
                        <?php foreach ($row1 as $var): ?>
                            ...
                            ?> 
                                <div align="left">
                                    ...
                                    <h2><a href="<?php echo base_url()."alojamiento/".$var['Url'] ?>" title="Hotel <?php echo ucwords($var['Nombre']); ?> en San Rafael" onclick="javascript:_gaq.push(['_trackEvent','click','Promo-Home','<?php echo ucwords($var['Nombre']); ?>']);"><?php echo ucwords($var['Nombre']); ?></a></h2>
                                    <p><?php echo acortar($var['Descripcion'],100); ?>.. </p>
                                    <span class="button"><a href="<?php echo base_url()."alojamiento/".$var['Url'] ?>" title="Hotel <?php echo ucwords($var['Nombre']); ?>- Ver Ficha Informacion">+ INFO</a> </span>
                                </div>
                       <?php $x++; ?>
                          <?php endforeach ?>
                                            <div class="masalojar" align="center"><span><a href="<?php echo base_url()."alojamiento/hoteles-san-rafael.html" ?>" title="Ver mas Hoteles en San Rafael">Ver más hoteles  >></a></span></div>
                    ...
                    <?php foreach ($row2 as $var): ?>
                            ...
                            ?> 
                                ...
                                <div align="left">
                                 ...
                                 <h2><a href="<?php echo base_url()."alojamiento/".$var['Url'] ?>" title="Cabañas <?php echo ucwords($var['Nombre']); ?> en San Rafael"><?php echo ucwords($var['Nombre']); ?></a></h2>
                            
                                    <p><?php echo acortar($var['Descripcion'],100); ?> </p>
                                    <span class="button"><a href="<?php echo base_url()."alojamiento/".$var['Url'] ?>" title="Cabañas <?php echo ucwords($var['Nombre']); ?>- Ver Ficha Informacion">+ INFO</a> </span>
                               </div>
                       
                          <?php endforeach ?>
                                                                      <div class="masalojar" align="center"><span><a href="<?php echo base_url()."alojamiento/cabanas-san-rafael.html" ?>" title="Ver mas Cabañas en San Rafael">Ver más Cabañas  >></a></span></div>
                        ...
                        <?php foreach ($row3 as $var): ?>
                            ...
                            ?> 
                                <div align="left">
                                  ...
                                  <h2><a href="<?php echo base_url()."alojamiento/".$var['Url'] ?>" title="Ver mas info <?php echo ucwords($var['Nombre']); ?> "><?php echo ucwords($var['Nombre']); ?></a></h2>
                            
                                    <p><?php echo acortar($var['Descripcion'],100); ?> </p>
                                    <span class="button"><a href="<?php echo base_url()."alojamiento/".$var['Url'] ?>" title="Chalet <?php echo ucwords($var['Nombre']); ?>- - Ver Ficha Informacion">+ INFO</a> </span>
                             
                                </div>
                         <?php $x++; ?>
                        <?php endforeach ?>
                        <div class="separador"></div>
                                                                      <div class="masalojar2" align="center"><span><a href="<?php echo base_url()."alojamiento/chalets-san-rafael.html" ?>" title="Ver mas Cabañas en San Rafael">Ver más Chalets  >></a></span></div>
                                                                      <div class="masalojar2" align="center"><span><a href="<?php echo base_url()."alojamiento/departamentos-san-rafael.html" ?>" title="Ver mas Cabañas en San Rafael">Ver más Deptos  >></a></span></div>
                    ...
                    <div id="alojar_tabs">
                          ...
                          <?php foreach ($row4 as $var): ?>
                                ...
                                <div>
                                    ...
                                    <p><?php echo acortar($var['Descripcion'],100); ?> </p>
                                    <span class="button"><a href="<?php echo base_url() ."servicios/turisticos/turismo-aventura/".$var['Url'] ; ?>" Title="<?php echo ucwords($var['Empresa']); ?> - Ficha Información">+ INFO</a> </span>
                                </div>
...
<!-- <p style="margin:0px"><a href="http://sanrafaellate.com.ar/propiedadessrl">Propiedades en San Rafael</a></p> -->
<img src="<?php echo base_url() ?>470.jpg" alt="">
</div>
            <!-- BEGUIN DESTACADOS-->
                ...
                <article>
                  <div align="left">
                   ...
                   <header>
                    ...
                    <h3>
                      <a href="<?php echo base_url().$var['TipoPagina']."/" .$var['Url'] ;  ?>" title="<?php echo ucwords($var['TituloContenido']); ?> - Ver Info completa"><?php echo ucwords($var['TituloContenido']); ?>
                      </a>
                    </h3>
                  </header> 
                    <section>
    ...
    <div id="carusel">
      ...
      <article>
        <div class="carusell">
            ...
            <header>
            <h3>
              <a href="<?php echo base_url(). "agenda/" . str_replace(" ","-",$var['Titulo'])."-".$var['ID_Agenda']; ?>" title="<?php echo "Ver Detalle Evento - ".ucwords($var['Titulo']) ?>"><?php echo ucwords($var['Titulo']); ?>
              </a>
            </h3>
            </header>
...
<div class="cont_120">
   ...
   <?php $this->load->view('website/ads_home_120-2'); ?>
...
<div class="cont_250">
  <img src="<?php echo base_url() ?>300.jpg" style="width:100%; height:auto" alt="">
           ...
           <div id="promociones"> 
            ...
            <?php foreach ($row_pro as $promo): ?>
             ...
             <div class="items" align="left">
              ...
              <div class="infopromo" >
                <div class="title"><a href="<?php echo base_url()."alojamiento/".$promo['Url'] ?>" title="info promocion <?php echo $promo['TipoAlojamiento']. " ". $promo['Nombre'] ?>"><?php if (strlen($promo['TipoAlojamiento']. " ". $promo['Nombre'])<20){echo ucwords($promo['TipoAlojamiento']. " ". $promo['Nombre']);} else {echo ucwords($promo['Nombre']);}   ?></a></div>
...
<div class="g-page" data-width="280" data-href="//plus.google.com/u/0/107577064684316171191" data-showtagline="false" data-rel="publisher"></div>
