...
<div id="contenedor2">
 ...
 <div id="cont_full">
         <!-- BEGUIN CONT FULL-->
      <div id="toplinks" align="left"><b>Estas en: </b><a href="<?php echo base_url(); ?>" title="Ir a home">Home</a> >> <a href="<?php echo base_url().'servicios/'.$tipoempresas['TipoEmpresa'];?>" title="<?php echo $tipoempresas['TituloEmpresa']; ?>"> <?php echo $tipoempresas['TituloEmpresa']; ?></a> </div>
