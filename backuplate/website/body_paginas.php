<div id="contenedor2">
 ...
 <div id="cont_full" align="left">
   <!-- BEGUIN CONT FULL-->
       <div id="toplinks" align="left"><b>Estas en: </b><a href="<?php echo base_url(); ?>" title="Ir a home">Home</a> >> <a href="<?php echo base_url() .$row_P['TipoPagina']."/". $row_P['UrlPagina'];?>" title="<?php echo $row_P['TipoPagina']; ?> en <?php echo $this->config->item('ciudadweb'); ?>"><?php echo $row_P['TituloPagina']; ?> </a> >> <?php echo $row_P['TituloContenido']; ?> en <?php echo $this->config->item('ciudadweb');?></div>
