...
class Home extends CI_Controller {
	...
	public function index()
	{
		...
		$data['body']="home";
			$data['page']="home";
		$data['titulo']="Compra , Venta y Alquiler de Propiedades en San Rafael Mendoza ";
		$data['descripcion']="Comra, vende y alquila tu Propiedades en San Rafael - casas , lotes, fincas, terrenos, departamentos.  ";
...
public function listado_po($a)
	{
		...
		$distritoget= $this->input->get('distrito');
...
// DATOS DEL PAGE
		$data['body']="listado_prop";
			$data['page']="listado";
		$data['titulo']=$a." de Propiedades en " .$distritoget . " San Rafael  | Casas - Departamentos - Locales - Lotes -Fincas  ";
		$data['descripcion']="Avisos de Propiedades en ".$a."  ".$distritoget.", San Rafael Mendoza, Casas , departamentos, lotes, Fincas, Bodegas.";
	...
	// DATOS DEL PAGE
		$data['body']="listado_prop";
			$data['page']="listado";
		$data['titulo']=$a."s en " .$distritoget." San Rafael | Venta - Compra - Alquiler  ";
		$data['descripcion']="Avisos de ".$a."s en ".$distritoget." San Rafael Mendoza, compra , venta, alquiler de ".$a."s. ";
...
public function buscador($tipo, $zona, $operacion, $precio1, $precio2)
	...
	if ($limit1=="" && $limit2=="") 	{	$limit1=0;	$limit2=18;	}
		...
		$data['body']="buscador";
		if ($tipo!=0 && $zona!=0 && $operacion!=0 ) {

		$data['titulo']= $operacion ." de ". $tipo."s en ".$zona." | San Rafael Mendoza   ";
		$data['descripcion']=$countpprop." ".$tipo."s en ".$operacion." encontrados en ".$zona." - San Rafael Mendoza - Propiedades" ;
			...
			$data['titulo']= "Propiedades en San Rafael:| ".$tipo ." ".$zona." ".$operacion ;
	...
	//estadisticas 
		...
		$data['body']="detalle";
		$data['page']="detalle";
		$data['titulo']=$data['Prop']['Titulo']." | San Rafael Mendoza ";
		$data['descripcion']=$data['Prop']['Descripcion']." ";
