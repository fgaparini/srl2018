...
public function listado_po($a)
	{
		...
		if (!isset($distritoGET)) {
			$distritoGET="";
			$data['TituloPage'] = $a."s en San Rafael ";

		} else 
		{
			$data['TituloPage'] = $a."s en " .$distritoGET." San Rafael ";
		}
...
// DATOS DEL PAGE
	...
	// DATOS DEL PAGE
		$data['body']="listado_prop";
			$data['page']="listado";
		$data['titulo']=$a."s en " .$distritoGET." San Rafael Mendoza | Venta - Compra - Alquiler  ";
		$data['descripcion']="Avisos Venta o alquiler de ".$a."s en " .$distritoGET." San Rafael Mendoza, compre , venda, alquiler de ".$a."s ";
