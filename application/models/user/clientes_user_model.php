...
class Clientes_user_model extends CI_Model
{
    ...
    function login($Usuario, $Clave)
    {
        ...
        $query=sprintf("select  c.*,ac. ID_Alojamiento  from clientes c, alojamientos_clientes ac where c.Usuario='%s' and c.Clave='%s' and ac.ID_Cliente=c.ID_Cliente GROUP BY ac.ID_Alojamiento ",$Usuario,$Clave);
