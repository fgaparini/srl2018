...
class Metododepago_user_model extends CI_Model
{

    const tabla = 'metododepago';
    const id_tabla = 'ID_MP';
    ...
    //--------------------- ENCONTRAR POR PAIS PROVINCIA CIUDAD--------------------
    
     function find_from_pais_provincia_ciudad($pais, $provincia, $ciudad)
    {
