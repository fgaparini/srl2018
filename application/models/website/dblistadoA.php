...
WHERE i.ID_InformacionGeneral=a.ID_InformacionGeneral AND a.ID_TipoAlojamiento=%s %s  AND a.DestaOrden>'0' AND a.Activo ='A'  ORDEN BY a.DestaOrden ASC
...
$query= sprintf("Select i.Nombre, i.Descripcion,i.Telefonom i.Email, i.Direccion,a.Url, a.ID_Alojamiento  FROM alojamientos a, informaciongeneral i 
WHERE i.ID_InformacionGeneral=a.ID_InformacionGeneral AND a.ID_TipoAlojamiento=%s AND a.DestaOrden='0' AND a.Activo ='A'  ORDEN BY RAND()
