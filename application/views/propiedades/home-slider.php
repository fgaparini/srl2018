...
<div class="container">
                ...
                <div class="images span9">
                    <div class='iosSlider'>
                        <div class='slider-content'>
                            <div class="slide">
                                <img src="<?php echo base_url(); ?>propiedadessrl/img/tmp/property-large-1.jpg" alt="">
                            ...
                            <div class="slide">
                                <img src="<?php echo base_url(); ?>propiedadessrl/img/tmp/property-large-2.jpg" alt="">
                            ...
                            <div class="slide">
                                <img src="<?php echo base_url(); ?>propiedadessrl/img/tmp/property-large-3.jpg" alt="">
    ...
    <div class="row">
        <div class="property span3">
            <div class="image">
                <div class="content">
                    ...
                    <img src="<?php echo base_url(); ?>propiedades-asset/img/tmp/property-small-1.png" alt="">
                </div><!-- /.content -->
        ...
        <div class="property span3">
            <div class="image">
                <div class="content">
                    <a href="detail.html"></a>
                    <img src="<?php echo base_url(); ?>propiedades-asset/img/tmp/property-small-2.png" alt="">
                </div><!-- /.content -->
                <div class="price">1 250 000€</div><!-- /.price -->
                <div class="reduced">Reduced </div><!-- /.reduced -->
            </div><!-- /.image -->
        ...
        <div class="property span3">
            <div class="image">
                <div class="content">
                    <a href="detail.html"></a>
                    <img src="<?php echo base_url(); ?>propiedades-asset/img/tmp/property-small-3.png" alt="">
                </div><!-- /.content -->
        ...
        <div class="property span3">
            <div class="image">
                <div class="content">
                    <a href="detail.html"></a>
                    <img src="<?php echo base_url(); ?>propiedades-asset/img/tmp/property-small-4.png" alt="">
                </div><!-- /.content -->
                <div class="price">1 250 000€</div><!-- /.price -->
                <div class="reduced">Reduced </div><!-- /.reduced -->
            </div><!-- /.image -->
        ...
        <div class="property span3">
            <div class="image">
                <div class="content">
                    <a href="detail.html"></a>
                    <img src="<?php echo base_url(); ?>propiedades-asset/img/tmp/property-small-5.png" alt="">
                </div><!-- /.content -->
        ...
        <div class="property span3">
            <div class="image">
                <div class="content">
                    <a href="detail.html"></a>
                    <img src="<?php echo base_url(); ?>propiedades-asset/img/tmp/property-small-6.png" alt="">
                </div><!-- /.content -->
    ...
    <div class="content">
        ...
        <div class="agent">
            <div class="image">
                <img src="<?php echo base_url(); ?>propiedades-asset/img/photos/john-small.png" alt="">
            </div><!-- /.image -->
    ...
    <div class="content">
        ...
        <ul>
            ...
            <li>
                <div class="image">
                    <a href="detail.html"></a>
                    <img src="<?php echo base_url(); ?>propiedades-asset-asset/img/tmp/property-small-3.png" alt="">
                </div><!-- /.image -->
                <div class="title">
                    <h3><a href="detail.html">27523 Pacific Coast</a></h3>
                </div><!-- /.title -->
            ...
            <li>
                <div class="image">
                    <a href="detail.html"></a>
                    <img src="<?php echo base_url(); ?>propiedades-asset-asset/img/tmp/property-small-4.png" alt="">
                </div><!-- /.image -->
                <div class="title">
                    <h3><a href="detail.html">27523 Pacific Coast</a></h3>
                </div><!-- /.title -->
    ...
    <div class="row">
        <div class="item span4">
            <div class="row">
                <div class="icon span1">
                    <img src="<?php echo base_url(); ?>propiedades/img/icons/features-seo.png" alt="">
                </div><!-- /.icon -->
        ...
        <div class="item span4">
            <div class="row">
                <div class="icon span1">
                    <img src="<?php echo base_url(); ?>propiedades/img/icons/features-retina.png" alt="">
                </div><!-- /.icon -->
        ...
        <div class="item span4">
            <div class="row">
                <div class="icon span1">
                    <img src="<?php echo base_url(); ?>propiedades/img/icons/features-custom-widgets.png" alt="">
                </div><!-- /.icon -->
    ...
    <div class="row">
        <div class="item span4">
            <div class="row">
                <div class="icon span1">
                    <img src="<?php echo base_url(); ?>propiedades/img/icons/features-bootstrap.png" alt="">
                </div><!-- /.icon -->
        ...
        <div class="item span4">
            <div class="row">
                <div class="icon span1">
                    <img src="<?php echo base_url(); ?>propiedades/img/icons/features-pencil.png" alt="">
                </div><!-- /.icon -->
        ...
        <div class="item span4">
            <div class="row">
                <div class="icon span1">
                    <img src="<?php echo base_url(); ?>propiedades/img/icons/features-responsive.png" alt="">
                </div><!-- /.icon -->
