...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="<?php echo base_url() ?>propiedades/admin/css/bootstrap.css" rel="stylesheet">

    <!-- Add custom CSS here -->
    <link href="<?php echo base_url() ?>propiedades/admin/css/sb-admin.css" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo base_url() ?>propiedades/admin/font-awesome/css/font-awesome.min.css">
    <!-- Page Specific CSS -->
  ...
  <body>
    ...
    <!-- JavaScript -->
    <script src="<?php echo base_url() ?>propiedades/admin/js/jquery-1.10.2.js"></script>
    <script src="<?php echo base_url() ?>propiedades/admin/js/bootstrap.js"></script>

    <!-- Page Specific Plugins -->
    <script src="http://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
    <script src="http://cdn.oesmith.co.uk/morris-0.4.3.min.js"></script>
    <script src="<?php echo base_url() ?>propiedades/admin/js/morris/chart-data-morris.js"></script>
    <script src="<?php echo base_url() ?>propiedades/admin/js/tablesorter/jquery.tablesorter.js"></script>
    <script src="<?php echo base_url() ?>propiedades/admin/js/tablesorter/tables.js"></script>
