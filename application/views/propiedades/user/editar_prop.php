...
<form  class= "form-horizontal"  role= "form" action="<?php echo base_url() ?>propiedadessrl/adminuser/save" method="post" >
        <div class="col-lg-5">
         
          <div  class= "form-group" >
            <h3>Informacion Propiedad <hr></h3>
          ...
          <div  class= "form-group" >
            ...
            <div  class= "form-group" >
             <label  for= "direccion"  class= "" > Direccion <small style="color:#C4C6BB">(sin abreviar Nombres)</small> </label>
            <div  class= "" >
  ...
  <label  for= "banos"  class= "" > Baños </label>
       ...
       <div  class= "form-group" >
            ...
            <div  class= "" >
              ...
              <div  class= "form-group bg-success" style="padding:3px 5px 15px 5px; " > <h3 >Valor Propiedad </h3>
                 <div class="col-lg-6">
            ...
            <button class="btn btn-primary rigth btn-lg" id="editprop">Editar Propiedad</button>
