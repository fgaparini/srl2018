<div id="page-wrapper">
  <div class="row"> 
    <div class="col-lg-12">
<p></p>
  <h1><span class="fa fa-home fa-1x"></span> <?php echo $infoprop['Titulo'] ?> (#<?php echo $prop['ID_Propiedades'] ?>)
...
<!-- fichaaa -->
              ...
              <div class="table-resposive">
                    ...
                    <div class="col-lg-10"><h2>Descripcion</h2><p><strong><?php echo $infoprop['Descripcion'] ?></p></div>
