...
<head>
   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,700,300' rel='stylesheet' type='text/css'>
    <link rel="shortcut icon" href="<?php echo base_url() ?>propiedades/img/favicon.png" type="image/png">
    <link rel="stylesheet" href="<?php echo base_url() ?>propiedades/css/bootstrap.css" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url() ?>propiedades/css/bootstrap-responsive.css" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url() ?>propiedades/css/chosen.css" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url() ?>propiedades/css/bootstrap-fileupload.css" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url() ?>propiedades/css/jquery-ui-1.10.2.custom.min.css" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url() ?>propiedades/css/realia-blue.css" type="text/css" id="color-variant-default">
...
<script type="text/javascript" src="<?php echo base_url() ?>propiedades//js/jquery.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>propiedades//js/jquery.ezmark.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>propiedades//js/jquery.currency.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>propiedades//js/jquery.cookie.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>propiedades//js/retina.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>propiedades//js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>propiedades//js/carousel.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>propiedades//js/gmap3.min.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>propiedades//js/gmap3.infobox.min.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>propiedades/js/jquery-ui-1.10.2.custom.min.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>propiedades/js/chosen.jquery.min.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>propiedades/js/jquery.iosslider.min.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>propiedades/js/bootstrap-fileupload.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>propiedades//js/realia.js"></script>
<script>
