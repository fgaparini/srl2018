...
<html lang="es">
  <head>
    ...
    <link href='http://fonts.googleapis.com/css?family=Averia+Libre' rel='stylesheet' type='text/css'>   <script type="text/javascript" src="<?php echo base_url() ?>swf/home_swf.js"></script>
  </head>
  <body>
    ...
    <div align="center" id="general">
      <header>
        <nav>
          <div id="menu-mobile">
             <img src="<?php echo base_url() ?>logo_nuevo2.png" class="logo" alt="SAN RAFAEL LATE " Title="<?php echo $this->config->item('nameweb');; ?> - Portal de Turismo de <?php echo $this->config->item('ciudadweb');; ?> " border="0">
            <div id="menu-icon">Menu</div>

            <ul id="nav-mobile">
              <li><a href="#">Descubrela</a></li>
              <li><a href="#">Alojamientos</a></li>
              <li><a href="#">Info Turistas</a></li>
                ...
                <ul align="left">
                  ...
                  <li class="menuss" id="descubrela" align="left">
                    ...
                    <div class="submenu" align="left">
                      ...
                      <div><ul class="">
                        ...
                        <li><a href="<?php echo base_url(); ?>san-rafael/historia-san-rafael.html" title="Reseña Historia de San Rafael"><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt="">Reseña Histotica</a></li>
                        <li><a href="<?php echo base_url(); ?>san-rafael/demografia-san-rafael.html" tilte="informacion geografica San Rafael "><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt=" ">Geografia</a></li>
                        <li><a href="<?php echo base_url(); ?>multimedia/Mapas/Ciudad" title="Mapa Interactivo de la ciudad "><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt=" ">Mapa Interactivo Ciudad</a></li>
                        <li><a href="<?php echo base_url(); ?>servicios/transporte/" title="Guia de transporte San Rafael "><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt="">Guia de Transporte</a></li>
                        <li><a href="<?php echo base_url(); ?>san-rafael/datos-utiles-san-rafael.html" title="Datos Utiles " ><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt=" ">Telefonos de Utilidad</a></li>
                    ...
                    <div class="submenu" align="left" >
                      ...
                      <div id="alojamiento" class="border_rigth">
                        ...
                        <ul class="twocolum">
                          ...
                          <li><a href="<?php echo base_url()."alojamiento/". $var['UrlAlojamiento'] ?>" title="Listado de <?php echo $var['TituloAlojamiento']; ?> en <?php echo $this->config->item('ciudadweb'); ?> "><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt="<?php echo $var['TituloAlojamiento']; ?> en San Rafael "><?php echo $var['TituloAlojamiento'] ;?></a></li>
                  ...
                  <div class="submenu" align="left" >
                    ...
                    <div class="border_rigth"><ul>
                      ...
                      <li><a href="<?php echo base_url(); ?>servicios/transporte/alquiler-autos-san-rafael.html" title="Alquiler de Autos en <?php echo $this->config->item('ciudadweb'); ?> "><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt=" ">Alquiler Autos</a></li>
                      <li><a href="<?php echo base_url(); ?>servicios/turisticos/turismo-aventura-san-rafael.html" title="Empresas Turismo Aventura en <?php echo $this->config->item('ciudadweb');; ?> "><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt="excursiones ">Empresas Aventura</a></li>
                  ...
                  <div class=""><ul>
                    ...
                    <li><a href="<?php echo base_url(); ?>circuitos-turisticos/canon-atuel.html" title="Conozca el imponente Cañon del Atuel"><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt=" cañon del atuel <?php echo $this->config->item('ciudadweb');; ?> ">Cañon del Atuel</a></li>
                    <!-- <li><a href="<?php echo base_url(); ?>vinos/champanera-bianchi" title="Descubra La Champañera Bianchi"><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt=" chanpañera <?php echo $this->config->item('ciudadweb');; ?>">Champañera Bianchi</a></li>-->
                ...
                <div id="circuitos">
                  <div>
                    <a href="<?php echo base_url(); ?>circuitos-turisticos/valle-grande.html" title="Descubri Valle Grande <?php echo $this->config->item('ciudadweb');; ?> ">
                      ...
                      <img src="<?php echo base_url() ?>imagenes/valleGrande.jpg" class="lafoto" alt="Valle Grande San Rafael">
                      <h3>Valle Grande</h3>
                    </a>
                  </div>
                  <div>
            ...
            <div class="submenu" align="left">
              ...
              <div id="tAventura" class="border_rigth">
                ...
                <ul class="twocolum">
                  ...
                  <li><a href="<?php echo base_url(); ?>turismo-aventura/barranquismo.html" title="barranquismo en <?php echo $this->config->item('ciudadweb');; ?> "><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt=" barranquismo ">Barranquismo</a></li>
                  <li><a href="<?php echo base_url(); ?>turismo-aventura/cabalgatas.html" title="Cabalgatas en <?php echo $this->config->item('ciudadweb');; ?> "><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt=" cabalgatas ">Cabalgatas</a></li>
                  ...
                  <li><a href="<?php echo base_url(); ?>turismo-aventura/4x4.html" title="Aventura 4x4 en <?php echo $this->config->item('ciudadweb');; ?> "><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt=" aventura 4x4 ">Aventura 4x4</a></li>
                  ...
                  <li><a href="<?php echo base_url(); ?>turismo-aventura/catamaran.html" title="catamaran en <?php echo $this->config->item('ciudadweb');; ?> "><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt=" catamaran ">Catamaran</a></li>
              ...
              <div class=""><ul>
                ...
                <li><a href="<?php echo base_url(); ?>actividades/festivales-san-rafael.html" title="Festivales de <?php echo $this->config->item('ciudadweb');; ?> "><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt=" festivales <?php echo $this->config->item('ciudadweb');; ?> ">Festivales</a></li>
                <li><a href="<?php echo base_url(); ?>actividades/museos-cultura-san-rafael.html" title="Listado de Museos y casas de cultura <?php echo $this->config->item('ciudadweb');; ?> "><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt=" Museos y casas Cultura ">Museos y Cultura</a></li>
                <li><a href="<?php echo base_url(); ?>actividades/congresos-convenciones-san-rafael.html" title="Centro de Congresos y convenciones <?php echo $this->config->item('ciudadweb');; ?> "><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt=" congresos <?php echo $this->config->item('ciudadweb');; ?> ">Congresos y convenciones</a></li>
                <li><a href="<?php echo base_url(); ?>servicios/actividades/regionales-san-rafael.html" title="Regionales y Artesanias <?php echo $this->config->item('ciudadweb');; ?> "><img src="<?php echo base_url() ?>iconos/flecha_3.png" class="ico" alt=" regionales ">Regionales</a></li>
