...
<div id="contenedor2">
  <div align="" id="titulos">
    <div align="left">
      ...
      <p class="estasaqui"><span class="here">Estas Aqui</span>: <a href="http://sanrafaellate.com.ar" title="Ir a home">Home</a> >> <a href="<?php echo base_url().'alojamientos/alojamientos-san-rafael.html';?>" title="Alojamientos en <?php echo $this->config->item('ciudadweb');; ?>">Alojamientos  </a>>> <?php echo $titulo_p; ?> en  <?php echo $this->config->item('ciudadweb');; ?> </p>
    </div>
</div>
  <div id="cont_full">
    <!-- BEGUIN CONT FULL-->
