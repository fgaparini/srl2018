...
<div id="contenedor2">
	<div id="cont_full" align="left">
		<!-- BEGUIN CONT FULL-->
		<div id="toplinks" align="left"><b>Estas en: </b><a href="http://sanrafaellate.com" title="Ir a home">Home</a> >> Destacados</div>
		<div class="cont_margin" >
			<div class="tituloSocial" align="left">
				<div><h1>Destacados - <?php echo  ucwords(str_replace("-"," ",$tipopag)) ?></h1> </div>
				<!-- DIV SOCIALES -->
			...
			<div id="listpag" align="left">
				...
				<div>
					...
					<div class="infoa">
						...
						<p><b> <?php echo $var['TituloPagina'] ?></b></p>
		...
		<div id="adsC">
			...
			<div id="relation">
				<div id="agendames">
					<h2>Destacados por Categoria</h2>
					<?php if($tipopag!="todos"){ ?>
						<div align="center"><a href="<?php echo base_url()."destacados/todos" ?>">Ver Todos</a></div>
					<?php } ?>
					<?php
					foreach ($listartipos as $var) {
						if($var['TituloPagina']!=NULL) {?>
							<div align="center"><a href="<?php echo base_url()."destacados/".$var['TipoPagina'] ?>"><?php echo $var['TituloPagina'] ; ?></a></div>
						<?php } 
					} ?>
				</div>
				<!-- /.relactionItem -->
