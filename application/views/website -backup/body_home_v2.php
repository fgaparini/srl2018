  ...
  <div id="home-slider" >
    <ul>
      ...
      <li data-transition="fade" data-slotamount="5" data-masterspeed="300" data-slideindex="back">
        ...
        <img src="<?php echo base_url() ?>imagenes/home_p2.jpg" >
        
        <!-- CAPTIONS OF FIRST SLIDE -->
        <div class="caption medium_text_shadow  lfb fadeout"
          data-x="center"
          data-hoffset="0"
          data-voffset="-184"
          data-y="bottom"
          ...
          data-easing="easeOutExpo"> Bienvenidos a San Rafael,
        </div>
        
        <div class="caption  modern_big_redbg lfb fadeout"
          data-x="center"
          data-hoffset="0"
          data-voffset="-134"
          data-y="bottom"
          ...
          data-captionhidden="on"
          data-endeasing="easeOutExpo"
          data-easing="easeOutExpo">Luz Benegas
        </div>
      ...
      <li data-transition="fade" data-slotamount="5" data-masterspeed="300" data-slideindex="back">
        ...
        <!-- THE MAIN IMAGE IN THE SLIDE -->
        <img src="<?php echo base_url() ?>imagenes/home_p1.jpg" >
        ...
        <div class="caption medium_text_shadow  lfb fadeout"
          ...
          data-captionhidden="on"
          data-endeasing="easeOutExpo"
          data-easing="easeOutExpo"> Bienvenidos a San Rafael numero 2,
        </div>
