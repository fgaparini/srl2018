<div id="contenedor2">
 ...
 <div id="cont_full" align="left">
   <!-- BEGUIN CONT FULL-->
       <div id="toplinks" align="left"><b>Estas en: </b><a href="<?php echo base_url(); ?>" title="Ir a home">Home</a> >> Mapas Ciudad</div>
...
<div id="contenido">
  <div id="videostube">
  <?php foreach ($videotube as $var) {?>  
<div>
    <a href="<?php echo $var['UrlVideo'] ;?>" class="videoY"  title="video -  <?php echo $var['NombreVideo']." - ". $this->config->item('ciudadweb'); ?> "><img src="http://img.youtube.com/vi/<?php echo  $var['thumbVideo']."/0.jpg";?>" alt="Video -  <?php echo $var['NombreVideo']." - ". $this->config->item('ciudadweb'); ?> "></a>
    <h2><a href="<?php echo $var['UrlVideo'] ;?>" class="videoY"  title="ideo -  <?php echo $var['NombreVideo']." - ". $this->config->item('ciudadweb'); ?> "><?php echo $var['NombreVideo'];?></a></h2>
