...
<!--[if (gt IE 8)|!(IE)]><!--><html lang="en" class="no-js"><!--<![endif]-->
    <head>
        ...
        <?php if (isset($css)): ?>
            ...
            <?php endforeach ?>
        <?php endif; ?>
        <?php if (isset($css_media)): ?>
            <?php foreach ($css_media as $var): ?>
                <link type="text/css" href="<?php echo base_url() . $var ?>.css" media="print" rel="stylesheet" />
            <?php endforeach ?>
        <?php endif; ?>
                <style>
                    body,html {width: 100%;height: 100%;}
                    .backnegro {background:#000000;width:100%;heigth:600px;position:absolute; left:0; top:0;}
                    .iframe{position:absolute; top:30%; left:20%;width:30%;heigth:auto; background:#FFF;}
