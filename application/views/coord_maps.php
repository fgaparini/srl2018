...
if ($infoprop['Coordenadas']!="")
{

 $coordenadas = explode(".", $infoprop['Coordenadas']);
 $latitud = $coordenadas[0];
 $logitud = $coordenadas[1];
 $direcion ="";
}

if ($infoprop['Coordenadas']=="" && $infoprop['Direccion'] !="")
{


 $direcion =$infoprop['Direccion'];
 $coordenadas="";
}
...
<div id="formulario">
  ...
  <form name="form_mapa" method="POST" enctype="multipart/form-data">
	...
	<td><p style="font-size: 10px;font-family: verdana;font-weight: bold;">
	    &nbsp;&nbsp;||&nbsp;&nbsp;Lat:&nbsp;<input type="text" name="latitud" value="<?php echo $latitud;?>" style="width: 100px;font-size: 10px;font-family: verdana;font-weight: bold;" />	    
	</p>
	</td>
	<td> <p style="font-size: 10px;font-family: verdana;font-weight: bold;">
	   Lon:&nbsp; <input type="text" name="longitud" value="<?php echo $longitud;?>" style="width: 100px;font-size: 10px;font-family: verdana;font-weight: bold;" />	
