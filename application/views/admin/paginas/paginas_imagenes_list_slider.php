<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            ...
            <div class="row-fluid">
                <div class="span5">
                    <form action="<?php echo base_url() ?>admin/paginas/paginas_imagenes_save_slider/" method="post" enctype="multipart/form-data">
                        ...
                        <br><label for="">Distancia y</label>
                                                            <input type="text" name="yxial">
                ...
                <table class="table">
                    ...
                    <?php foreach ($paginas_imagenes_array as $var): ?>
                        <tr id="i_<?php echo $var['ImagenPagina'] ?>">
                            <td><?php echo $var['ID_Pagina'] . "_" . $var['ImagenPagina'] . "_slider.jpg" ?></td>
                            <td>
                                <a rel="example_group" href="<?php echo base_url() . "upload/paginas/" . $var['ID_Pagina'] . "_" . $var['ImagenPagina'] . "_slider.jpg" ?>"><img  class="last" width="50px" src="<?php echo base_url() . "upload/paginas/" . $var['ID_Pagina'] . "_" . $var['ImagenPagina'] . "_slider.jpg" ?>"></a>
                            </td>
                            <td>
                                <form action="<?php echo base_url() ?>admin/paginas/paginas_imagenes_save_slider/" method="post" enctype="multipart/form-data">
                                    <input type="file" name="filesToUpload[]" id="filesToUpload" multiple=""  value="Agregar Foto">
                                    ...
                                    <input type="text" name="yxial" class="input-small">

                                    <input name="foto_numero" value="<?php echo $var['ImagenPagina'] ?>" type="hidden" />
                                </form>
                            </td>
                            <td>
                                <form id="<?php echo $var['ImagenPagina'] ?>"  class="form-inline descripcion_form_slider">
